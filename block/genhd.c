...
<html lang='en'>
<head>
<title>genhd.c « block - kernel/git/torvalds/linux.git - Linux kernel source tree</title>
<meta name='generator' content='cgit 1.2.3-1.el7'/>
<meta name='robots' content='noindex, nofollow'/>
<link rel='stylesheet' type='text/css' href='/cgit-data/cgit.css'/>
<link rel='shortcut icon' href='/favicon.ico'/>
<link rel='alternate' title='Atom feed' href='http://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/atom/block/genhd.c?h=master' type='application/atom+xml'/>
...
<input type='hidden' name='id' value='aebf5db917055b38f4945ed6d621d9f07a44ff30'/><select name='h' onchange='this.form.submit();'>
<option value='master' selected='selected'>master</option>
</select> <input type='submit' value='switch'/></form></td></tr>
<tr><td class='sub'>Linux kernel source tree</td><td class='sub right'>Linus Torvalds</td></tr></table>
<table class='tabs'><tr><td>
<a href='/pub/scm/linux/kernel/git/torvalds/linux.git/about/'>about</a><a href='/pub/scm/linux/kernel/git/torvalds/linux.git/'>summary</a><a href='/pub/scm/linux/kernel/git/torvalds/linux.git/refs/?id=aebf5db917055b38f4945ed6d621d9f07a44ff30'>refs</a><a href='/pub/scm/linux/kernel/git/torvalds/linux.git/log/block/genhd.c'>log</a><a class='active' href='/pub/scm/linux/kernel/git/torvalds/linux.git/tree/block/genhd.c?id=aebf5db917055b38f4945ed6d621d9f07a44ff30'>tree</a><a href='/pub/scm/linux/kernel/git/torvalds/linux.git/commit/block/genhd.c?id=aebf5db917055b38f4945ed6d621d9f07a44ff30'>commit</a><a href='/pub/scm/linux/kernel/git/torvalds/linux.git/diff/block/genhd.c?id=aebf5db917055b38f4945ed6d621d9f07a44ff30'>diff</a><a href='/pub/scm/linux/kernel/git/torvalds/linux.git/stats/block/genhd.c'>stats</a></td><td class='form'><form class='right' method='get' action='/pub/scm/linux/kernel/git/torvalds/linux.git/log/block/genhd.c'>
<input type='hidden' name='id' value='aebf5db917055b38f4945ed6d621d9f07a44ff30'/><select name='qt'>
...
<div class='path'>path: <a href='/pub/scm/linux/kernel/git/torvalds/linux.git/tree/?id=aebf5db917055b38f4945ed6d621d9f07a44ff30'>root</a>/<a href='/pub/scm/linux/kernel/git/torvalds/linux.git/tree/block?id=aebf5db917055b38f4945ed6d621d9f07a44ff30'>block</a>/<a href='/pub/scm/linux/kernel/git/torvalds/linux.git/tree/block/genhd.c?id=aebf5db917055b38f4945ed6d621d9f07a44ff30'>genhd.c</a></div><div class='content'>blob: 419548e92d82f6216995293928b1c0e2f63f1d4c (<a href='/pub/scm/linux/kernel/git/torvalds/linux.git/plain/block/genhd.c?id=aebf5db917055b38f4945ed6d621d9f07a44ff30'>plain</a>)
...
.highlight .il { color: #0000DD; font-weight: bold } /* Literal.Number.Integer.Long */</style><div class="highlight"><pre><span></span><span class="c1">// SPDX-License-Identifier: GPL-2.0</span>
<span class="cm">/*</span>
<span class="cm"> *  gendisk handling</span>
<span class="cm"> *</span>
<span class="cm"> * Portions Copyright (C) 2020 Christoph Hellwig</span>
<span class="cm"> */</span>

<span class="cp">#include</span> <span class="cpf">&lt;linux/module.h&gt;</span><span class="cp"></span>
<span class="cp">#include</span> <span class="cpf">&lt;linux/ctype.h&gt;</span><span class="cp"></span>
...
<span class="cp">#include</span> <span class="cpf">&lt;linux/kdev_t.h&gt;</span><span class="cp"></span>
...
<span class="cp">#include</span> <span class="cpf">&lt;linux/idr.h&gt;</span><span class="cp"></span>
<span class="cp">#include</span> <span class="cpf">&lt;linux/log2.h&gt;</span><span class="cp"></span>
<span class="cp">#include</span> <span class="cpf">&lt;linux/pm_runtime.h&gt;</span><span class="cp"></span>
<span class="cp">#include</span> <span class="cpf">&lt;linux/badblocks.h&gt;</span><span class="cp"></span>

<span class="cp">#include</span> <span class="cpf">&quot;blk.h&quot;</span><span class="cp"></span>

<span class="k">static</span> <span class="k">struct</span> <span class="n">kobject</span> <span class="o">*</span><span class="n">block_depr</span><span class="p">;</span>

<span class="n">DECLARE_RWSEM</span><span class="p">(</span><span class="n">bdev_lookup_sem</span><span class="p">);</span>

<span class="cm">/* for extended dynamic devt allocation, currently only one major is used */</span>
<span class="cp">#define NR_EXT_DEVT		(1 &lt;&lt; MINORBITS)</span>
<span class="k">static</span> <span class="nf">DEFINE_IDA</span><span class="p">(</span><span class="n">ext_devt_ida</span><span class="p">);</span>

<span class="k">static</span> <span class="kt">void</span> <span class="nf">disk_check_events</span><span class="p">(</span><span class="k">struct</span> <span class="n">disk_events</span> <span class="o">*</span><span class="n">ev</span><span class="p">,</span>
			      <span class="kt">unsigned</span> <span class="kt">int</span> <span class="o">*</span><span class="n">clearing_ptr</span><span class="p">);</span>
...
<span class="kt">void</span> <span class="nf">set_capacity</span><span class="p">(</span><span class="k">struct</span> <span class="n">gendisk</span> <span class="o">*</span><span class="n">disk</span><span class="p">,</span> <span class="n">sector_t</span> <span class="n">sectors</span><span class="p">)</span>
<span class="p">{</span>
	<span class="k">struct</span> <span class="n">block_device</span> <span class="o">*</span><span class="n">bdev</span> <span class="o">=</span> <span class="n">disk</span><span class="o">-&gt;</span><span class="n">part0</span><span class="p">;</span>

	<span class="n">spin_lock</span><span class="p">(</span><span class="o">&amp;</span><span class="n">bdev</span><span class="o">-&gt;</span><span class="n">bd_size_lock</span><span class="p">);</span>
	<span class="n">i_size_write</span><span class="p">(</span><span class="n">bdev</span><span class="o">-&gt;</span><span class="n">bd_inode</span><span class="p">,</span> <span class="p">(</span><span class="n">loff_t</span><span class="p">)</span><span class="n">sectors</span> <span class="o">&lt;&lt;</span> <span class="n">SECTOR_SHIFT</span><span class="p">);</span>
	<span class="n">spin_unlock</span><span class="p">(</span><span class="o">&amp;</span><span class="n">bdev</span><span class="o">-&gt;</span><span class="n">bd_size_lock</span><span class="p">);</span>
<span class="p">}</span>
<span class="n">EXPORT_SYMBOL</span><span class="p">(</span><span class="n">set_capacity</span><span class="p">);</span>

<span class="cm">/*</span>
<span class="cm"> * Set disk capacity and notify if the size is not currently zero and will not</span>
<span class="cm"> * be set to zero.  Returns true if a uevent was sent, otherwise false.</span>
<span class="cm"> */</span>
<span class="kt">bool</span> <span class="nf">set_capacity_and_notify</span><span class="p">(</span><span class="k">struct</span> <span class="n">gendisk</span> <span class="o">*</span><span class="n">disk</span><span class="p">,</span> <span class="n">sector_t</span> <span class="n">size</span><span class="p">)</span>
<span class="p">{</span>
	<span class="n">sector_t</span> <span class="n">capacity</span> <span class="o">=</span> <span class="n">get_capacity</span><span class="p">(</span><span class="n">disk</span><span class="p">);</span>
	<span class="kt">char</span> <span class="o">*</span><span class="n">envp</span><span class="p">[]</span> <span class="o">=</span> <span class="p">{</span> <span class="s">&quot;RESIZE=1&quot;</span><span class="p">,</span> <span class="nb">NULL</span> <span class="p">};</span>

	<span class="n">set_capacity</span><span class="p">(</span><span class="n">disk</span><span class="p">,</span> <span class="n">size</span><span class="p">);</span>

	<span class="cm">/*</span>
<span class="cm">	 * Only print a message and send a uevent if the gendisk is user visible</span>
<span class="cm">	 * and alive.  This avoids spamming the log and udev when setting the</span>
<span class="cm">	 * initial capacity during probing.</span>
<span class="cm">	 */</span>
	<span class="k">if</span> <span class="p">(</span><span class="n">size</span> <span class="o">==</span> <span class="n">capacity</span> <span class="o">||</span>
	    <span class="p">(</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">flags</span> <span class="o">&amp;</span> <span class="p">(</span><span class="n">GENHD_FL_UP</span> <span class="o">|</span> <span class="n">GENHD_FL_HIDDEN</span><span class="p">))</span> <span class="o">!=</span> <span class="n">GENHD_FL_UP</span><span class="p">)</span>
		<span class="k">return</span> <span class="nb">false</span><span class="p">;</span>

	<span class="n">pr_info</span><span class="p">(</span><span class="s">&quot;%s: detected capacity change from %lld to %lld</span><span class="se">\n</span><span class="s">&quot;</span><span class="p">,</span>
		<span class="n">disk</span><span class="o">-&gt;</span><span class="n">disk_name</span><span class="p">,</span> <span class="n">size</span><span class="p">,</span> <span class="n">capacity</span><span class="p">);</span>

	<span class="cm">/*</span>
<span class="cm">	 * Historically we did not send a uevent for changes to/from an empty</span>
<span class="cm">	 * device.</span>
<span class="cm">	 */</span>
	<span class="k">if</span> <span class="p">(</span><span class="o">!</span><span class="n">capacity</span> <span class="o">||</span> <span class="o">!</span><span class="n">size</span><span class="p">)</span>
		<span class="k">return</span> <span class="nb">false</span><span class="p">;</span>
...
<span class="p">}</span>
<span class="n">EXPORT_SYMBOL_GPL</span><span class="p">(</span><span class="n">set_capacity_and_notify</span><span class="p">);</span>

<span class="cm">/*</span>
<span class="cm"> * Format the device name of the indicated disk into the supplied buffer and</span>
<span class="cm"> * return a pointer to that same buffer for convenience.</span>
<span class="cm"> */</span>
<span class="kt">char</span> <span class="o">*</span><span class="nf">disk_name</span><span class="p">(</span><span class="k">struct</span> <span class="n">gendisk</span> <span class="o">*</span><span class="n">hd</span><span class="p">,</span> <span class="kt">int</span> <span class="n">partno</span><span class="p">,</span> <span class="kt">char</span> <span class="o">*</span><span class="n">buf</span><span class="p">)</span>
<span class="p">{</span>
	<span class="k">if</span> <span class="p">(</span><span class="o">!</span><span class="n">partno</span><span class="p">)</span>
		<span class="n">snprintf</span><span class="p">(</span><span class="n">buf</span><span class="p">,</span> <span class="n">BDEVNAME_SIZE</span><span class="p">,</span> <span class="s">&quot;%s&quot;</span><span class="p">,</span> <span class="n">hd</span><span class="o">-&gt;</span><span class="n">disk_name</span><span class="p">);</span>
	<span class="k">else</span> <span class="k">if</span> <span class="p">(</span><span class="n">isdigit</span><span class="p">(</span><span class="n">hd</span><span class="o">-&gt;</span><span class="n">disk_name</span><span class="p">[</span><span class="n">strlen</span><span class="p">(</span><span class="n">hd</span><span class="o">-&gt;</span><span class="n">disk_name</span><span class="p">)</span><span class="o">-</span><span class="mi">1</span><span class="p">]))</span>
		<span class="n">snprintf</span><span class="p">(</span><span class="n">buf</span><span class="p">,</span> <span class="n">BDEVNAME_SIZE</span><span class="p">,</span> <span class="s">&quot;%sp%d&quot;</span><span class="p">,</span> <span class="n">hd</span><span class="o">-&gt;</span><span class="n">disk_name</span><span class="p">,</span> <span class="n">partno</span><span class="p">);</span>
	<span class="k">else</span>
		<span class="n">snprintf</span><span class="p">(</span><span class="n">buf</span><span class="p">,</span> <span class="n">BDEVNAME_SIZE</span><span class="p">,</span> <span class="s">&quot;%s%d&quot;</span><span class="p">,</span> <span class="n">hd</span><span class="o">-&gt;</span><span class="n">disk_name</span><span class="p">,</span> <span class="n">partno</span><span class="p">);</span>

	<span class="k">return</span> <span class="n">buf</span><span class="p">;</span>
<span class="p">}</span>

<span class="k">const</span> <span class="kt">char</span> <span class="o">*</span><span class="nf">bdevname</span><span class="p">(</span><span class="k">struct</span> <span class="n">block_device</span> <span class="o">*</span><span class="n">bdev</span><span class="p">,</span> <span class="kt">char</span> <span class="o">*</span><span class="n">buf</span><span class="p">)</span>
<span class="p">{</span>
	<span class="k">return</span> <span class="n">disk_name</span><span class="p">(</span><span class="n">bdev</span><span class="o">-&gt;</span><span class="n">bd_disk</span><span class="p">,</span> <span class="n">bdev</span><span class="o">-&gt;</span><span class="n">bd_partno</span><span class="p">,</span> <span class="n">buf</span><span class="p">);</span>
<span class="p">}</span>
<span class="n">EXPORT_SYMBOL</span><span class="p">(</span><span class="n">bdevname</span><span class="p">);</span>

<span class="k">static</span> <span class="kt">void</span> <span class="nf">part_stat_read_all</span><span class="p">(</span><span class="k">struct</span> <span class="n">block_device</span> <span class="o">*</span><span class="n">part</span><span class="p">,</span>
		<span class="k">struct</span> <span class="n">disk_stats</span> <span class="o">*</span><span class="n">stat</span><span class="p">)</span>
<span class="p">{</span>
	<span class="kt">int</span> <span class="n">cpu</span><span class="p">;</span>

	<span class="n">memset</span><span class="p">(</span><span class="n">stat</span><span class="p">,</span> <span class="mi">0</span><span class="p">,</span> <span class="k">sizeof</span><span class="p">(</span><span class="k">struct</span> <span class="n">disk_stats</span><span class="p">));</span>
	<span class="n">for_each_possible_cpu</span><span class="p">(</span><span class="n">cpu</span><span class="p">)</span> <span class="p">{</span>
		<span class="k">struct</span> <span class="n">disk_stats</span> <span class="o">*</span><span class="n">ptr</span> <span class="o">=</span> <span class="n">per_cpu_ptr</span><span class="p">(</span><span class="n">part</span><span class="o">-&gt;</span><span class="n">bd_stats</span><span class="p">,</span> <span class="n">cpu</span><span class="p">);</span>
		<span class="kt">int</span> <span class="n">group</span><span class="p">;</span>

		<span class="k">for</span> <span class="p">(</span><span class="n">group</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span> <span class="n">group</span> <span class="o">&lt;</span> <span class="n">NR_STAT_GROUPS</span><span class="p">;</span> <span class="n">group</span><span class="o">++</span><span class="p">)</span> <span class="p">{</span>
			<span class="n">stat</span><span class="o">-&gt;</span><span class="n">nsecs</span><span class="p">[</span><span class="n">group</span><span class="p">]</span> <span class="o">+=</span> <span class="n">ptr</span><span class="o">-&gt;</span><span class="n">nsecs</span><span class="p">[</span><span class="n">group</span><span class="p">];</span>
			<span class="n">stat</span><span class="o">-&gt;</span><span class="n">sectors</span><span class="p">[</span><span class="n">group</span><span class="p">]</span> <span class="o">+=</span> <span class="n">ptr</span><span class="o">-&gt;</span><span class="n">sectors</span><span class="p">[</span><span class="n">group</span><span class="p">];</span>
			<span class="n">stat</span><span class="o">-&gt;</span><span class="n">ios</span><span class="p">[</span><span class="n">group</span><span class="p">]</span> <span class="o">+=</span> <span class="n">ptr</span><span class="o">-&gt;</span><span class="n">ios</span><span class="p">[</span><span class="n">group</span><span class="p">];</span>
			<span class="n">stat</span><span class="o">-&gt;</span><span class="n">merges</span><span class="p">[</span><span class="n">group</span><span class="p">]</span> <span class="o">+=</span> <span class="n">ptr</span><span class="o">-&gt;</span><span class="n">merges</span><span class="p">[</span><span class="n">group</span><span class="p">];</span>
		<span class="p">}</span>

		<span class="n">stat</span><span class="o">-&gt;</span><span class="n">io_ticks</span> <span class="o">+=</span> <span class="n">ptr</span><span class="o">-&gt;</span><span class="n">io_ticks</span><span class="p">;</span>
	<span class="p">}</span>
<span class="p">}</span>

<span class="k">static</span> <span class="kt">unsigned</span> <span class="kt">int</span> <span class="nf">part_in_flight</span><span class="p">(</span><span class="k">struct</span> <span class="n">block_device</span> <span class="o">*</span><span class="n">part</span><span class="p">)</span>
<span class="p">{</span>
	<span class="kt">unsigned</span> <span class="kt">int</span> <span class="n">inflight</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span>
	<span class="kt">int</span> <span class="n">cpu</span><span class="p">;</span>

	<span class="n">for_each_possible_cpu</span><span class="p">(</span><span class="n">cpu</span><span class="p">)</span> <span class="p">{</span>
		<span class="n">inflight</span> <span class="o">+=</span> <span class="n">part_stat_local_read_cpu</span><span class="p">(</span><span class="n">part</span><span class="p">,</span> <span class="n">in_flight</span><span class="p">[</span><span class="mi">0</span><span class="p">],</span> <span class="n">cpu</span><span class="p">)</span> <span class="o">+</span>
			    <span class="n">part_stat_local_read_cpu</span><span class="p">(</span><span class="n">part</span><span class="p">,</span> <span class="n">in_flight</span><span class="p">[</span><span class="mi">1</span><span class="p">],</span> <span class="n">cpu</span><span class="p">);</span>
	<span class="p">}</span>
	<span class="k">if</span> <span class="p">((</span><span class="kt">int</span><span class="p">)</span><span class="n">inflight</span> <span class="o">&lt;</span> <span class="mi">0</span><span class="p">)</span>
		<span class="n">inflight</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span>

	<span class="k">return</span> <span class="n">inflight</span><span class="p">;</span>
<span class="p">}</span>

<span class="k">static</span> <span class="kt">void</span> <span class="nf">part_in_flight_rw</span><span class="p">(</span><span class="k">struct</span> <span class="n">block_device</span> <span class="o">*</span><span class="n">part</span><span class="p">,</span>
		<span class="kt">unsigned</span> <span class="kt">int</span> <span class="n">inflight</span><span class="p">[</span><span class="mi">2</span><span class="p">])</span>
<span class="p">{</span>
	<span class="kt">int</span> <span class="n">cpu</span><span class="p">;</span>

	<span class="n">inflight</span><span class="p">[</span><span class="mi">0</span><span class="p">]</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span>
	<span class="n">inflight</span><span class="p">[</span><span class="mi">1</span><span class="p">]</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span>
	<span class="n">for_each_possible_cpu</span><span class="p">(</span><span class="n">cpu</span><span class="p">)</span> <span class="p">{</span>
		<span class="n">inflight</span><span class="p">[</span><span class="mi">0</span><span class="p">]</span> <span class="o">+=</span> <span class="n">part_stat_local_read_cpu</span><span class="p">(</span><span class="n">part</span><span class="p">,</span> <span class="n">in_flight</span><span class="p">[</span><span class="mi">0</span><span class="p">],</span> <span class="n">cpu</span><span class="p">);</span>
		<span class="n">inflight</span><span class="p">[</span><span class="mi">1</span><span class="p">]</span> <span class="o">+=</span> <span class="n">part_stat_local_read_cpu</span><span class="p">(</span><span class="n">part</span><span class="p">,</span> <span class="n">in_flight</span><span class="p">[</span><span class="mi">1</span><span class="p">],</span> <span class="n">cpu</span><span class="p">);</span>
	<span class="p">}</span>
	<span class="k">if</span> <span class="p">((</span><span class="kt">int</span><span class="p">)</span><span class="n">inflight</span><span class="p">[</span><span class="mi">0</span><span class="p">]</span> <span class="o">&lt;</span> <span class="mi">0</span><span class="p">)</span>
		<span class="n">inflight</span><span class="p">[</span><span class="mi">0</span><span class="p">]</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span>
	<span class="k">if</span> <span class="p">((</span><span class="kt">int</span><span class="p">)</span><span class="n">inflight</span><span class="p">[</span><span class="mi">1</span><span class="p">]</span> <span class="o">&lt;</span> <span class="mi">0</span><span class="p">)</span>
		<span class="n">inflight</span><span class="p">[</span><span class="mi">1</span><span class="p">]</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span>
<span class="p">}</span>

<span class="k">struct</span> <span class="n">block_device</span> <span class="o">*</span><span class="nf">__disk_get_part</span><span class="p">(</span><span class="k">struct</span> <span class="n">gendisk</span> <span class="o">*</span><span class="n">disk</span><span class="p">,</span> <span class="kt">int</span> <span class="n">partno</span><span class="p">)</span>
<span class="p">{</span>
	<span class="k">struct</span> <span class="n">disk_part_tbl</span> <span class="o">*</span><span class="n">ptbl</span> <span class="o">=</span> <span class="n">rcu_dereference</span><span class="p">(</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">part_tbl</span><span class="p">);</span>

	<span class="k">if</span> <span class="p">(</span><span class="n">unlikely</span><span class="p">(</span><span class="n">partno</span> <span class="o">&lt;</span> <span class="mi">0</span> <span class="o">||</span> <span class="n">partno</span> <span class="o">&gt;=</span> <span class="n">ptbl</span><span class="o">-&gt;</span><span class="n">len</span><span class="p">))</span>
		<span class="k">return</span> <span class="nb">NULL</span><span class="p">;</span>
	<span class="k">return</span> <span class="n">rcu_dereference</span><span class="p">(</span><span class="n">ptbl</span><span class="o">-&gt;</span><span class="n">part</span><span class="p">[</span><span class="n">partno</span><span class="p">]);</span>
<span class="p">}</span>
...
<span class="cm"> * Don&#39;t care.</span>
<span class="cm"> */</span>
<span class="k">struct</span> <span class="n">block_device</span> <span class="o">*</span><span class="nf">disk_part_iter_next</span><span class="p">(</span><span class="k">struct</span> <span class="n">disk_part_iter</span> <span class="o">*</span><span class="n">piter</span><span class="p">)</span>
<span class="p">{</span>
	<span class="k">struct</span> <span class="n">disk_part_tbl</span> <span class="o">*</span><span class="n">ptbl</span><span class="p">;</span>
	...
	<span class="n">disk_part_iter_exit</span><span class="p">(</span><span class="n">piter</span><span class="p">);</span>
	...
	<span class="k">for</span> <span class="p">(;</span> <span class="n">piter</span><span class="o">-&gt;</span><span class="n">idx</span> <span class="o">!=</span> <span class="n">end</span><span class="p">;</span> <span class="n">piter</span><span class="o">-&gt;</span><span class="n">idx</span> <span class="o">+=</span> <span class="n">inc</span><span class="p">)</span> <span class="p">{</span>
		<span class="k">struct</span> <span class="n">block_device</span> <span class="o">*</span><span class="n">part</span><span class="p">;</span>
		...
		<span class="n">piter</span><span class="o">-&gt;</span><span class="n">part</span> <span class="o">=</span> <span class="n">bdgrab</span><span class="p">(</span><span class="n">part</span><span class="p">);</span>
		<span class="k">if</span> <span class="p">(</span><span class="o">!</span><span class="n">piter</span><span class="o">-&gt;</span><span class="n">part</span><span class="p">)</span>
			<span class="k">continue</span><span class="p">;</span>
		<span class="k">if</span> <span class="p">(</span><span class="o">!</span><span class="n">bdev_nr_sectors</span><span class="p">(</span><span class="n">part</span><span class="p">)</span> <span class="o">&amp;&amp;</span>
		    ...
		    <span class="o">!</span><span class="p">(</span><span class="n">piter</span><span class="o">-&gt;</span><span class="n">flags</span> <span class="o">&amp;</span> <span class="n">DISK_PITER_INCL_EMPTY_PART0</span> <span class="o">&amp;&amp;</span>
		      <span class="n">piter</span><span class="o">-&gt;</span><span class="n">idx</span> <span class="o">==</span> <span class="mi">0</span><span class="p">))</span> <span class="p">{</span>
			<span class="n">bdput</span><span class="p">(</span><span class="n">piter</span><span class="o">-&gt;</span><span class="n">part</span><span class="p">);</span>
			<span class="n">piter</span><span class="o">-&gt;</span><span class="n">part</span> <span class="o">=</span> <span class="nb">NULL</span><span class="p">;</span>
			<span class="k">continue</span><span class="p">;</span>
		<span class="p">}</span>
...
<span class="p">{</span>
	<span class="k">if</span> <span class="p">(</span><span class="n">piter</span><span class="o">-&gt;</span><span class="n">part</span><span class="p">)</span>
		<span class="n">bdput</span><span class="p">(</span><span class="n">piter</span><span class="o">-&gt;</span><span class="n">part</span><span class="p">);</span>
	<span class="n">piter</span><span class="o">-&gt;</span><span class="n">part</span> <span class="o">=</span> <span class="nb">NULL</span><span class="p">;</span>
<span class="p">}</span>
<span class="n">EXPORT_SYMBOL_GPL</span><span class="p">(</span><span class="n">disk_part_iter_exit</span><span class="p">);</span>

<span class="k">static</span> <span class="kr">inline</span> <span class="kt">int</span> <span class="nf">sector_in_part</span><span class="p">(</span><span class="k">struct</span> <span class="n">block_device</span> <span class="o">*</span><span class="n">part</span><span class="p">,</span> <span class="n">sector_t</span> <span class="n">sector</span><span class="p">)</span>
<span class="p">{</span>
	<span class="k">return</span> <span class="n">part</span><span class="o">-&gt;</span><span class="n">bd_start_sect</span> <span class="o">&lt;=</span> <span class="n">sector</span> <span class="o">&amp;&amp;</span>
		<span class="n">sector</span> <span class="o">&lt;</span> <span class="n">part</span><span class="o">-&gt;</span><span class="n">bd_start_sect</span> <span class="o">+</span> <span class="n">bdev_nr_sectors</span><span class="p">(</span><span class="n">part</span><span class="p">);</span>
<span class="p">}</span>
...
<span class="cm"> *</span>
<span class="cm"> * CONTEXT:</span>
<span class="cm"> * RCU read locked.</span>
<span class="cm"> *</span>
<span class="cm"> * RETURNS:</span>
<span class="cm"> * Found partition on success, part0 is returned if no partition matches</span>
<span class="cm"> * or the matched partition is being deleted.</span>
<span class="cm"> */</span>
<span class="k">struct</span> <span class="n">block_device</span> <span class="o">*</span><span class="nf">disk_map_sector_rcu</span><span class="p">(</span><span class="k">struct</span> <span class="n">gendisk</span> <span class="o">*</span><span class="n">disk</span><span class="p">,</span> <span class="n">sector_t</span> <span class="n">sector</span><span class="p">)</span>
<span class="p">{</span>
	<span class="k">struct</span> <span class="n">disk_part_tbl</span> <span class="o">*</span><span class="n">ptbl</span><span class="p">;</span>
	<span class="k">struct</span> <span class="n">block_device</span> <span class="o">*</span><span class="n">part</span><span class="p">;</span>
	...
	<span class="n">part</span> <span class="o">=</span> <span class="n">disk</span><span class="o">-&gt;</span><span class="n">part0</span><span class="p">;</span>
...
<span class="cm">/**</span>
<span class="cm"> * disk_has_partitions</span>
<span class="cm"> * @disk: gendisk of interest</span>
<span class="cm"> *</span>
<span class="cm"> * Walk through the partition table and check if valid partition exists.</span>
<span class="cm"> *</span>
<span class="cm"> * CONTEXT:</span>
<span class="cm"> * Don&#39;t care.</span>
<span class="cm"> *</span>
<span class="cm"> * RETURNS:</span>
<span class="cm"> * True if the gendisk has at least one valid non-zero size partition.</span>
<span class="cm"> * Otherwise false.</span>
<span class="cm"> */</span>
<span class="kt">bool</span> <span class="nf">disk_has_partitions</span><span class="p">(</span><span class="k">struct</span> <span class="n">gendisk</span> <span class="o">*</span><span class="n">disk</span><span class="p">)</span>
<span class="p">{</span>
	<span class="k">struct</span> <span class="n">disk_part_tbl</span> <span class="o">*</span><span class="n">ptbl</span><span class="p">;</span>
	<span class="kt">int</span> <span class="n">i</span><span class="p">;</span>
	...
	<span class="cm">/* Iterate partitions skipping the whole device at index 0 */</span>
	<span class="k">for</span> <span class="p">(</span><span class="n">i</span> <span class="o">=</span> <span class="mi">1</span><span class="p">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">ptbl</span><span class="o">-&gt;</span><span class="n">len</span><span class="p">;</span> <span class="n">i</span><span class="o">++</span><span class="p">)</span> <span class="p">{</span>
		<span class="k">if</span> <span class="p">(</span><span class="n">rcu_dereference</span><span class="p">(</span><span class="n">ptbl</span><span class="o">-&gt;</span><span class="n">part</span><span class="p">[</span><span class="n">i</span><span class="p">]))</span> <span class="p">{</span>
...
<span class="p">}</span>
<span class="n">EXPORT_SYMBOL_GPL</span><span class="p">(</span><span class="n">disk_has_partitions</span><span class="p">);</span>
...
<span class="k">static</span> <span class="k">struct</span> <span class="n">blk_major_name</span> <span class="p">{</span>
	...
	<span class="kt">void</span> <span class="p">(</span><span class="o">*</span><span class="n">probe</span><span class="p">)(</span><span class="kt">dev_t</span> <span class="n">devt</span><span class="p">);</span>
...
<span class="k">static</span> <span class="nf">DEFINE_MUTEX</span><span class="p">(</span><span class="n">major_names_lock</span><span class="p">);</span>
...
<span class="p">{</span>
	...
	<span class="n">mutex_lock</span><span class="p">(</span><span class="o">&amp;</span><span class="n">major_names_lock</span><span class="p">);</span>
	<span class="k">for</span> <span class="p">(</span><span class="n">dp</span> <span class="o">=</span> <span class="n">major_names</span><span class="p">[</span><span class="n">major_to_index</span><span class="p">(</span><span class="n">offset</span><span class="p">)];</span> <span class="n">dp</span><span class="p">;</span> <span class="n">dp</span> <span class="o">=</span> <span class="n">dp</span><span class="o">-&gt;</span><span class="n">next</span><span class="p">)</span>
		<span class="k">if</span> <span class="p">(</span><span class="n">dp</span><span class="o">-&gt;</span><span class="n">major</span> <span class="o">==</span> <span class="n">offset</span><span class="p">)</span>
	...
	<span class="n">mutex_unlock</span><span class="p">(</span><span class="o">&amp;</span><span class="n">major_names_lock</span><span class="p">);</span>
<span class="p">}</span>
...
<span class="cm"> * @probe: allback that is called on access to any minor number of @major</span>
<span class="cm"> *</span>
...
<span class="cm"> */</span>
<span class="kt">int</span> <span class="nf">__register_blkdev</span><span class="p">(</span><span class="kt">unsigned</span> <span class="kt">int</span> <span class="n">major</span><span class="p">,</span> <span class="k">const</span> <span class="kt">char</span> <span class="o">*</span><span class="n">name</span><span class="p">,</span>
		<span class="kt">void</span> <span class="p">(</span><span class="o">*</span><span class="n">probe</span><span class="p">)(</span><span class="kt">dev_t</span> <span class="n">devt</span><span class="p">))</span>
<span class="p">{</span>
	...
	<span class="k">if</span> <span class="p">(</span><span class="n">major</span> <span class="o">==</span> <span class="mi">0</span><span class="p">)</span> <span class="p">{</span>
		...
		<span class="k">if</span> <span class="p">(</span><span class="n">index</span> <span class="o">==</span> <span class="mi">0</span><span class="p">)</span> <span class="p">{</span>
			<span class="n">printk</span><span class="p">(</span><span class="s">&quot;%s: failed to get major for %s</span><span class="se">\n</span><span class="s">&quot;</span><span class="p">,</span>
	...
	<span class="k">if</span> <span class="p">(</span><span class="n">major</span> <span class="o">&gt;=</span> <span class="n">BLKDEV_MAJOR_MAX</span><span class="p">)</span> <span class="p">{</span>
		<span class="n">pr_err</span><span class="p">(</span><span class="s">&quot;%s: major requested (%u) is greater than the maximum (%u) for %s</span><span class="se">\n</span><span class="s">&quot;</span><span class="p">,</span>
		       <span class="n">__func__</span><span class="p">,</span> <span class="n">major</span><span class="p">,</span> <span class="n">BLKDEV_MAJOR_MAX</span><span class="o">-</span><span class="mi">1</span><span class="p">,</span> <span class="n">name</span><span class="p">);</span>
	...
	<span class="n">p</span><span class="o">-&gt;</span><span class="n">probe</span> <span class="o">=</span> <span class="n">probe</span><span class="p">;</span>
	...
	<span class="k">if</span> <span class="p">(</span><span class="n">ret</span> <span class="o">&lt;</span> <span class="mi">0</span><span class="p">)</span> <span class="p">{</span>
		<span class="n">printk</span><span class="p">(</span><span class="s">&quot;register_blkdev: cannot get major %u for %s</span><span class="se">\n</span><span class="s">&quot;</span><span class="p">,</span>
...
<span class="nl">out</span><span class="p">:</span>
	...
	<span class="k">return</span> <span class="n">ret</span><span class="p">;</span>
<span class="p">}</span>
<span class="n">EXPORT_SYMBOL</span><span class="p">(</span><span class="n">__register_blkdev</span><span class="p">);</span>
...
<span class="cm">/**</span>
<span class="cm"> * blk_alloc_devt - allocate a dev_t for a block device</span>
<span class="cm"> * @bdev: block device to allocate dev_t for</span>
...
<span class="cm"> */</span>
<span class="kt">int</span> <span class="nf">blk_alloc_devt</span><span class="p">(</span><span class="k">struct</span> <span class="n">block_device</span> <span class="o">*</span><span class="n">bdev</span><span class="p">,</span> <span class="kt">dev_t</span> <span class="o">*</span><span class="n">devt</span><span class="p">)</span>
<span class="p">{</span>
	...
	<span class="k">if</span> <span class="p">(</span><span class="n">bdev</span><span class="o">-&gt;</span><span class="n">bd_partno</span> <span class="o">&lt;</span> <span class="n">disk</span><span class="o">-&gt;</span><span class="n">minors</span><span class="p">)</span> <span class="p">{</span>
		<span class="o">*</span><span class="n">devt</span> <span class="o">=</span> <span class="n">MKDEV</span><span class="p">(</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">major</span><span class="p">,</span> <span class="n">disk</span><span class="o">-&gt;</span><span class="n">first_minor</span> <span class="o">+</span> <span class="n">bdev</span><span class="o">-&gt;</span><span class="n">bd_partno</span><span class="p">);</span>
		<span class="k">return</span> <span class="mi">0</span><span class="p">;</span>
	<span class="p">}</span>

	<span class="n">idx</span> <span class="o">=</span> <span class="n">ida_alloc_range</span><span class="p">(</span><span class="o">&amp;</span><span class="n">ext_devt_ida</span><span class="p">,</span> <span class="mi">0</span><span class="p">,</span> <span class="n">NR_EXT_DEVT</span><span class="p">,</span> <span class="n">GFP_KERNEL</span><span class="p">);</span>
	<span class="k">if</span> <span class="p">(</span><span class="n">idx</span> <span class="o">&lt;</span> <span class="mi">0</span><span class="p">)</span>
		<span class="k">return</span> <span class="n">idx</span> <span class="o">==</span> <span class="o">-</span><span class="n">ENOSPC</span> <span class="o">?</span> <span class="o">-</span><span class="nl">EBUSY</span> <span class="p">:</span> <span class="n">idx</span><span class="p">;</span>
...
<span class="cm"> * Might sleep.</span>
<span class="cm"> */</span>
<span class="kt">void</span> <span class="nf">blk_free_devt</span><span class="p">(</span><span class="kt">dev_t</span> <span class="n">devt</span><span class="p">)</span>
<span class="p">{</span>
	<span class="k">if</span> <span class="p">(</span><span class="n">MAJOR</span><span class="p">(</span><span class="n">devt</span><span class="p">)</span> <span class="o">==</span> <span class="n">BLOCK_EXT_MAJOR</span><span class="p">)</span>
		<span class="n">ida_free</span><span class="p">(</span><span class="o">&amp;</span><span class="n">ext_devt_ida</span><span class="p">,</span> <span class="n">blk_mangle_minor</span><span class="p">(</span><span class="n">MINOR</span><span class="p">(</span><span class="n">devt</span><span class="p">)));</span>
<span class="p">}</span>

<span class="k">static</span> <span class="kt">char</span> <span class="o">*</span><span class="nf">bdevt_str</span><span class="p">(</span><span class="kt">dev_t</span> <span class="n">devt</span><span class="p">,</span> <span class="kt">char</span> <span class="o">*</span><span class="n">buf</span><span class="p">)</span>
<span class="p">{</span>
...
<span class="k">static</span> <span class="kt">void</span> <span class="nf">disk_scan_partitions</span><span class="p">(</span><span class="k">struct</span> <span class="n">gendisk</span> <span class="o">*</span><span class="n">disk</span><span class="p">)</span>
<span class="p">{</span>
	<span class="k">struct</span> <span class="n">block_device</span> <span class="o">*</span><span class="n">bdev</span><span class="p">;</span>

	<span class="k">if</span> <span class="p">(</span><span class="o">!</span><span class="n">get_capacity</span><span class="p">(</span><span class="n">disk</span><span class="p">)</span> <span class="o">||</span> <span class="o">!</span><span class="n">disk_part_scan_enabled</span><span class="p">(</span><span class="n">disk</span><span class="p">))</span>
		<span class="k">return</span><span class="p">;</span>

	<span class="n">set_bit</span><span class="p">(</span><span class="n">GD_NEED_PART_SCAN</span><span class="p">,</span> <span class="o">&amp;</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">state</span><span class="p">);</span>
	<span class="n">bdev</span> <span class="o">=</span> <span class="n">blkdev_get_by_dev</span><span class="p">(</span><span class="n">disk_devt</span><span class="p">(</span><span class="n">disk</span><span class="p">),</span> <span class="n">FMODE_READ</span><span class="p">,</span> <span class="nb">NULL</span><span class="p">);</span>
	<span class="k">if</span> <span class="p">(</span><span class="o">!</span><span class="n">IS_ERR</span><span class="p">(</span><span class="n">bdev</span><span class="p">))</span>
...
<span class="k">static</span> <span class="kt">void</span> <span class="nf">register_disk</span><span class="p">(</span><span class="k">struct</span> <span class="n">device</span> <span class="o">*</span><span class="n">parent</span><span class="p">,</span> <span class="k">struct</span> <span class="n">gendisk</span> <span class="o">*</span><span class="n">disk</span><span class="p">,</span>
...
<span class="p">{</span>
	...
	<span class="n">ddev</span><span class="o">-&gt;</span><span class="n">parent</span> <span class="o">=</span> <span class="n">parent</span><span class="p">;</span>

	<span class="n">dev_set_name</span><span class="p">(</span><span class="n">ddev</span><span class="p">,</span> <span class="s">&quot;%s&quot;</span><span class="p">,</span> <span class="n">disk</span><span class="o">-&gt;</span><span class="n">disk_name</span><span class="p">);</span>
	...
	<span class="k">if</span> <span class="p">(</span><span class="n">groups</span><span class="p">)</span> <span class="p">{</span>
		<span class="n">WARN_ON</span><span class="p">(</span><span class="n">ddev</span><span class="o">-&gt;</span><span class="n">groups</span><span class="p">);</span>
		<span class="n">ddev</span><span class="o">-&gt;</span><span class="n">groups</span> <span class="o">=</span> <span class="n">groups</span><span class="p">;</span>
	<span class="p">}</span>
	...
	<span class="cm">/*</span>
<span class="cm">	 * avoid probable deadlock caused by allocating memory with</span>
<span class="cm">	 * GFP_KERNEL in runtime_resume callback of its all ancestor</span>
<span class="cm">	 * devices</span>
<span class="cm">	 */</span>
	<span class="n">pm_runtime_set_memalloc_noio</span><span class="p">(</span><span class="n">ddev</span><span class="p">,</span> <span class="nb">true</span><span class="p">);</span>

	<span class="n">disk</span><span class="o">-&gt;</span><span class="n">part0</span><span class="o">-&gt;</span><span class="n">bd_holder_dir</span> <span class="o">=</span>
		<span class="n">kobject_create_and_add</span><span class="p">(</span><span class="s">&quot;holders&quot;</span><span class="p">,</span> <span class="o">&amp;</span><span class="n">ddev</span><span class="o">-&gt;</span><span class="n">kobj</span><span class="p">);</span>
	...
	<span class="k">if</span> <span class="p">(</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">flags</span> <span class="o">&amp;</span> <span class="n">GENHD_FL_HIDDEN</span><span class="p">)</span> <span class="p">{</span>
	...
	<span class="n">disk_scan_partitions</span><span class="p">(</span><span class="n">disk</span><span class="p">);</span>
	...
	<span class="k">while</span> <span class="p">((</span><span class="n">part</span> <span class="o">=</span> <span class="n">disk_part_iter_next</span><span class="p">(</span><span class="o">&amp;</span><span class="n">piter</span><span class="p">)))</span>
		<span class="n">kobject_uevent</span><span class="p">(</span><span class="n">bdev_kobj</span><span class="p">(</span><span class="n">part</span><span class="p">),</span> <span class="n">KOBJ_ADD</span><span class="p">);</span>
	<span class="n">disk_part_iter_exit</span><span class="p">(</span><span class="o">&amp;</span><span class="n">piter</span><span class="p">);</span>

	<span class="k">if</span> <span class="p">(</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">queue</span><span class="o">-&gt;</span><span class="n">backing_dev_info</span><span class="o">-&gt;</span><span class="n">dev</span><span class="p">)</span> <span class="p">{</span>
		<span class="n">err</span> <span class="o">=</span> <span class="n">sysfs_create_link</span><span class="p">(</span><span class="o">&amp;</span><span class="n">ddev</span><span class="o">-&gt;</span><span class="n">kobj</span><span class="p">,</span>
			  <span class="o">&amp;</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">queue</span><span class="o">-&gt;</span><span class="n">backing_dev_info</span><span class="o">-&gt;</span><span class="n">dev</span><span class="o">-&gt;</span><span class="n">kobj</span><span class="p">,</span>
...
<span class="cm">/**</span>
<span class="cm"> * __device_add_disk - add disk information to kernel list</span>
...
<span class="cm"> * @register_queue: register the queue if set to true</span>
<span class="cm"> *</span>
...
<span class="cm"> */</span>
<span class="k">static</span> <span class="kt">void</span> <span class="nf">__device_add_disk</span><span class="p">(</span><span class="k">struct</span> <span class="n">device</span> <span class="o">*</span><span class="n">parent</span><span class="p">,</span> <span class="k">struct</span> <span class="n">gendisk</span> <span class="o">*</span><span class="n">disk</span><span class="p">,</span>
			      <span class="k">const</span> <span class="k">struct</span> <span class="n">attribute_group</span> <span class="o">**</span><span class="n">groups</span><span class="p">,</span>
			      <span class="kt">bool</span> <span class="n">register_queue</span><span class="p">)</span>
<span class="p">{</span>
	<span class="kt">dev_t</span> <span class="n">devt</span><span class="p">;</span>
	<span class="kt">int</span> <span class="n">retval</span><span class="p">;</span>

	<span class="cm">/*</span>
<span class="cm">	 * The disk queue should now be all set with enough information about</span>
<span class="cm">	 * the device for the elevator code to pick an adequate default</span>
<span class="cm">	 * elevator if one is needed, that is, for devices requesting queue</span>
<span class="cm">	 * registration.</span>
<span class="cm">	 */</span>
	<span class="k">if</span> <span class="p">(</span><span class="n">register_queue</span><span class="p">)</span>
		<span class="n">elevator_init_mq</span><span class="p">(</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">queue</span><span class="p">);</span>
...
<span class="cm">	 */</span>
	...
	<span class="n">WARN_ON</span><span class="p">(</span><span class="o">!</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">minors</span> <span class="o">&amp;&amp;</span>
		<span class="o">!</span><span class="p">(</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">flags</span> <span class="o">&amp;</span> <span class="p">(</span><span class="n">GENHD_FL_EXT_DEVT</span> <span class="o">|</span> <span class="n">GENHD_FL_HIDDEN</span><span class="p">)));</span>
	...
	<span class="n">retval</span> <span class="o">=</span> <span class="n">blk_alloc_devt</span><span class="p">(</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">part0</span><span class="p">,</span> <span class="o">&amp;</span><span class="n">devt</span><span class="p">);</span>
	...
	<span class="k">if</span> <span class="p">(</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">flags</span> <span class="o">&amp;</span> <span class="n">GENHD_FL_HIDDEN</span><span class="p">)</span> <span class="p">{</span>
		<span class="cm">/*</span>
<span class="cm">		 * Don&#39;t let hidden disks show up in /proc/partitions,</span>
<span class="cm">		 * and don&#39;t bother scanning for partitions either.</span>
<span class="cm">		 */</span>
		<span class="n">disk</span><span class="o">-&gt;</span><span class="n">flags</span> <span class="o">|=</span> <span class="n">GENHD_FL_SUPPRESS_PARTITION_INFO</span><span class="p">;</span>
	...
	<span class="p">}</span> <span class="k">else</span> <span class="p">{</span>
		<span class="k">struct</span> <span class="n">backing_dev_info</span> <span class="o">*</span><span class="n">bdi</span> <span class="o">=</span> <span class="n">disk</span><span class="o">-&gt;</span><span class="n">queue</span><span class="o">-&gt;</span><span class="n">backing_dev_info</span><span class="p">;</span>
		<span class="k">struct</span> <span class="n">device</span> <span class="o">*</span><span class="n">dev</span> <span class="o">=</span> <span class="n">disk_to_dev</span><span class="p">(</span><span class="n">disk</span><span class="p">);</span>
		...
		<span class="n">ret</span> <span class="o">=</span> <span class="n">bdi_register</span><span class="p">(</span><span class="n">bdi</span><span class="p">,</span> <span class="s">&quot;%u:%u&quot;</span><span class="p">,</span> <span class="n">MAJOR</span><span class="p">(</span><span class="n">devt</span><span class="p">),</span> <span class="n">MINOR</span><span class="p">(</span><span class="n">devt</span><span class="p">));</span>
		<span class="n">WARN_ON</span><span class="p">(</span><span class="n">ret</span><span class="p">);</span>
		<span class="n">bdi_set_owner</span><span class="p">(</span><span class="n">bdi</span><span class="p">,</span> <span class="n">dev</span><span class="p">);</span>
		<span class="n">bdev_add</span><span class="p">(</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">part0</span><span class="p">,</span> <span class="n">devt</span><span class="p">);</span>
	<span class="p">}</span>
	<span class="n">register_disk</span><span class="p">(</span><span class="n">parent</span><span class="p">,</span> <span class="n">disk</span><span class="p">,</span> <span class="n">groups</span><span class="p">);</span>
	<span class="k">if</span> <span class="p">(</span><span class="n">register_queue</span><span class="p">)</span>
...
<span class="cm">	 */</span>
	...
	<span class="n">blk_integrity_add</span><span class="p">(</span><span class="n">disk</span><span class="p">);</span>
<span class="p">}</span>

<span class="kt">void</span> <span class="nf">device_add_disk</span><span class="p">(</span><span class="k">struct</span> <span class="n">device</span> <span class="o">*</span><span class="n">parent</span><span class="p">,</span> <span class="k">struct</span> <span class="n">gendisk</span> <span class="o">*</span><span class="n">disk</span><span class="p">,</span>
		     <span class="k">const</span> <span class="k">struct</span> <span class="n">attribute_group</span> <span class="o">**</span><span class="n">groups</span><span class="p">)</span>

<span class="p">{</span>
	<span class="n">__device_add_disk</span><span class="p">(</span><span class="n">parent</span><span class="p">,</span> <span class="n">disk</span><span class="p">,</span> <span class="n">groups</span><span class="p">,</span> <span class="nb">true</span><span class="p">);</span>
<span class="p">}</span>
<span class="n">EXPORT_SYMBOL</span><span class="p">(</span><span class="n">device_add_disk</span><span class="p">);</span>

<span class="kt">void</span> <span class="nf">device_add_disk_no_queue_reg</span><span class="p">(</span><span class="k">struct</span> <span class="n">device</span> <span class="o">*</span><span class="n">parent</span><span class="p">,</span> <span class="k">struct</span> <span class="n">gendisk</span> <span class="o">*</span><span class="n">disk</span><span class="p">)</span>
<span class="p">{</span>
	<span class="n">__device_add_disk</span><span class="p">(</span><span class="n">parent</span><span class="p">,</span> <span class="n">disk</span><span class="p">,</span> <span class="nb">NULL</span><span class="p">,</span> <span class="nb">false</span><span class="p">);</span>
<span class="p">}</span>
<span class="n">EXPORT_SYMBOL</span><span class="p">(</span><span class="n">device_add_disk_no_queue_reg</span><span class="p">);</span>

<span class="k">static</span> <span class="kt">void</span> <span class="nf">invalidate_partition</span><span class="p">(</span><span class="k">struct</span> <span class="n">block_device</span> <span class="o">*</span><span class="n">bdev</span><span class="p">)</span>
<span class="p">{</span>
	...
	<span class="cm">/*</span>
<span class="cm">	 * Unhash the bdev inode for this device so that it can&#39;t be looked</span>
<span class="cm">	 * up any more even if openers still hold references to it.</span>
<span class="cm">	 */</span>
	<span class="n">remove_inode_hash</span><span class="p">(</span><span class="n">bdev</span><span class="o">-&gt;</span><span class="n">bd_inode</span><span class="p">);</span>
<span class="p">}</span>

<span class="cm">/**</span>
<span class="cm"> * del_gendisk - remove the gendisk</span>
<span class="cm"> * @disk: the struct gendisk to remove</span>
<span class="cm"> *</span>
<span class="cm"> * Removes the gendisk and all its associated resources. This deletes the</span>
<span class="cm"> * partitions associated with the gendisk, and unregisters the associated</span>
<span class="cm"> * request_queue.</span>
<span class="cm"> *</span>
<span class="cm"> * This is the counter to the respective __device_add_disk() call.</span>
<span class="cm"> *</span>
<span class="cm"> * The final removal of the struct gendisk happens when its refcount reaches 0</span>
<span class="cm"> * with put_disk(), which should be called after del_gendisk(), if</span>
<span class="cm"> * __device_add_disk() was used.</span>
<span class="cm"> *</span>
<span class="cm"> * Drivers exist which depend on the release of the gendisk to be synchronous,</span>
<span class="cm"> * it should not be deferred.</span>
<span class="cm"> *</span>
...
<span class="p">{</span>
	...
	<span class="k">if</span> <span class="p">(</span><span class="n">WARN_ON_ONCE</span><span class="p">(</span><span class="o">!</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">queue</span><span class="p">))</span>
		<span class="k">return</span><span class="p">;</span>

	<span class="n">blk_integrity_del</span><span class="p">(</span><span class="n">disk</span><span class="p">);</span>
	<span class="n">disk_del_events</span><span class="p">(</span><span class="n">disk</span><span class="p">);</span>

	<span class="cm">/*</span>
<span class="cm">	 * Block lookups of the disk until all bdevs are unhashed and the</span>
<span class="cm">	 * disk is marked as dead (GENHD_FL_UP cleared).</span>
<span class="cm">	 */</span>
	<span class="n">down_write</span><span class="p">(</span><span class="o">&amp;</span><span class="n">bdev_lookup_sem</span><span class="p">);</span>
	...
	<span class="k">while</span> <span class="p">((</span><span class="n">part</span> <span class="o">=</span> <span class="n">disk_part_iter_next</span><span class="p">(</span><span class="o">&amp;</span><span class="n">piter</span><span class="p">)))</span> <span class="p">{</span>
		<span class="n">invalidate_partition</span><span class="p">(</span><span class="n">part</span><span class="p">);</span>
		<span class="n">delete_partition</span><span class="p">(</span><span class="n">part</span><span class="p">);</span>
	<span class="p">}</span>
	<span class="n">disk_part_iter_exit</span><span class="p">(</span><span class="o">&amp;</span><span class="n">piter</span><span class="p">);</span>

	<span class="n">invalidate_partition</span><span class="p">(</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">part0</span><span class="p">);</span>
	...
	<span class="n">up_write</span><span class="p">(</span><span class="o">&amp;</span><span class="n">bdev_lookup_sem</span><span class="p">);</span>

	<span class="k">if</span> <span class="p">(</span><span class="o">!</span><span class="p">(</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">flags</span> <span class="o">&amp;</span> <span class="n">GENHD_FL_HIDDEN</span><span class="p">))</span> <span class="p">{</span>
		...
		<span class="cm">/*</span>
<span class="cm">		 * Unregister bdi before releasing device numbers (as they can</span>
<span class="cm">		 * get reused and we&#39;d get clashes in sysfs).</span>
<span class="cm">		 */</span>
		<span class="n">bdi_unregister</span><span class="p">(</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">queue</span><span class="o">-&gt;</span><span class="n">backing_dev_info</span><span class="p">);</span>
	<span class="p">}</span>

	<span class="n">blk_unregister_queue</span><span class="p">(</span><span class="n">disk</span><span class="p">);</span>

	<span class="n">kobject_put</span><span class="p">(</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">part0</span><span class="o">-&gt;</span><span class="n">bd_holder_dir</span><span class="p">);</span>
	...
	<span class="n">part_stat_set_all</span><span class="p">(</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">part0</span><span class="p">,</span> <span class="mi">0</span><span class="p">);</span>
	<span class="n">disk</span><span class="o">-&gt;</span><span class="n">part0</span><span class="o">-&gt;</span><span class="n">bd_stamp</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span>
	...
	<span class="n">pm_runtime_set_memalloc_noio</span><span class="p">(</span><span class="n">disk_to_dev</span><span class="p">(</span><span class="n">disk</span><span class="p">),</span> <span class="nb">false</span><span class="p">);</span>
...
<span class="k">static</span> <span class="kt">ssize_t</span> <span class="nf">disk_badblocks_show</span><span class="p">(</span><span class="k">struct</span> <span class="n">device</span> <span class="o">*</span><span class="n">dev</span><span class="p">,</span>
...
<span class="p">{</span>
	...
	<span class="k">if</span> <span class="p">(</span><span class="o">!</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">bb</span><span class="p">)</span>
	...
	<span class="k">return</span> <span class="n">badblocks_show</span><span class="p">(</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">bb</span><span class="p">,</span> <span class="n">page</span><span class="p">,</span> <span class="mi">0</span><span class="p">);</span>
<span class="p">}</span>

<span class="k">static</span> <span class="kt">ssize_t</span> <span class="nf">disk_badblocks_store</span><span class="p">(</span><span class="k">struct</span> <span class="n">device</span> <span class="o">*</span><span class="n">dev</span><span class="p">,</span>
					<span class="k">struct</span> <span class="n">device_attribute</span> <span class="o">*</span><span class="n">attr</span><span class="p">,</span>
					<span class="k">const</span> <span class="kt">char</span> <span class="o">*</span><span class="n">page</span><span class="p">,</span> <span class="kt">size_t</span> <span class="n">len</span><span class="p">)</span>
<span class="p">{</span>
	<span class="k">struct</span> <span class="n">gendisk</span> <span class="o">*</span><span class="n">disk</span> <span class="o">=</span> <span class="n">dev_to_disk</span><span class="p">(</span><span class="n">dev</span><span class="p">);</span>
	...
	<span class="k">return</span> <span class="n">badblocks_store</span><span class="p">(</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">bb</span><span class="p">,</span> <span class="n">page</span><span class="p">,</span> <span class="n">len</span><span class="p">,</span> <span class="mi">0</span><span class="p">);</span>
<span class="p">}</span>

<span class="kt">void</span> <span class="nf">blk_request_module</span><span class="p">(</span><span class="kt">dev_t</span> <span class="n">devt</span><span class="p">)</span>
<span class="p">{</span>
	<span class="kt">unsigned</span> <span class="kt">int</span> <span class="n">major</span> <span class="o">=</span> <span class="n">MAJOR</span><span class="p">(</span><span class="n">devt</span><span class="p">);</span>
	<span class="k">struct</span> <span class="n">blk_major_name</span> <span class="o">**</span><span class="n">n</span><span class="p">;</span>

	<span class="n">mutex_lock</span><span class="p">(</span><span class="o">&amp;</span><span class="n">major_names_lock</span><span class="p">);</span>
	<span class="k">for</span> <span class="p">(</span><span class="n">n</span> <span class="o">=</span> <span class="o">&amp;</span><span class="n">major_names</span><span class="p">[</span><span class="n">major_to_index</span><span class="p">(</span><span class="n">major</span><span class="p">)];</span> <span class="o">*</span><span class="n">n</span><span class="p">;</span> <span class="n">n</span> <span class="o">=</span> <span class="o">&amp;</span><span class="p">(</span><span class="o">*</span><span class="n">n</span><span class="p">)</span><span class="o">-&gt;</span><span class="n">next</span><span class="p">)</span> <span class="p">{</span>
		<span class="k">if</span> <span class="p">((</span><span class="o">*</span><span class="n">n</span><span class="p">)</span><span class="o">-&gt;</span><span class="n">major</span> <span class="o">==</span> <span class="n">major</span> <span class="o">&amp;&amp;</span> <span class="p">(</span><span class="o">*</span><span class="n">n</span><span class="p">)</span><span class="o">-&gt;</span><span class="n">probe</span><span class="p">)</span> <span class="p">{</span>
			<span class="p">(</span><span class="o">*</span><span class="n">n</span><span class="p">)</span><span class="o">-&gt;</span><span class="n">probe</span><span class="p">(</span><span class="n">devt</span><span class="p">);</span>
			<span class="n">mutex_unlock</span><span class="p">(</span><span class="o">&amp;</span><span class="n">major_names_lock</span><span class="p">);</span>
			<span class="k">return</span><span class="p">;</span>
		<span class="p">}</span>
	<span class="p">}</span>
...
<span class="p">{</span>
	...
	<span class="n">rcu_read_lock</span><span class="p">();</span>
	<span class="n">bdev</span> <span class="o">=</span> <span class="n">__disk_get_part</span><span class="p">(</span><span class="n">disk</span><span class="p">,</span> <span class="n">partno</span><span class="p">);</span>
	<span class="k">if</span> <span class="p">(</span><span class="n">bdev</span> <span class="o">&amp;&amp;</span> <span class="o">!</span><span class="n">bdgrab</span><span class="p">(</span><span class="n">bdev</span><span class="p">))</span>
...
<span class="cm">		 */</span>
		...
		<span class="k">while</span> <span class="p">((</span><span class="n">part</span> <span class="o">=</span> <span class="n">disk_part_iter_next</span><span class="p">(</span><span class="o">&amp;</span><span class="n">piter</span><span class="p">)))</span> <span class="p">{</span>
			<span class="kt">bool</span> <span class="n">is_part0</span> <span class="o">=</span> <span class="n">part</span> <span class="o">==</span> <span class="n">disk</span><span class="o">-&gt;</span><span class="n">part0</span><span class="p">;</span>
			...
			<span class="n">printk</span><span class="p">(</span><span class="s">&quot;%s%s %10llu %s %s&quot;</span><span class="p">,</span> <span class="n">is_part0</span> <span class="o">?</span> <span class="s">&quot;&quot;</span> <span class="o">:</span> <span class="s">&quot;  &quot;</span><span class="p">,</span>
			       <span class="n">bdevt_str</span><span class="p">(</span><span class="n">part</span><span class="o">-&gt;</span><span class="n">bd_dev</span><span class="p">,</span> <span class="n">devt_buf</span><span class="p">),</span>
			       <span class="n">bdev_nr_sectors</span><span class="p">(</span><span class="n">part</span><span class="p">)</span> <span class="o">&gt;&gt;</span> <span class="mi">1</span><span class="p">,</span>
			       <span class="n">disk_name</span><span class="p">(</span><span class="n">disk</span><span class="p">,</span> <span class="n">part</span><span class="o">-&gt;</span><span class="n">bd_partno</span><span class="p">,</span> <span class="n">name_buf</span><span class="p">),</span>
			       <span class="n">part</span><span class="o">-&gt;</span><span class="n">bd_meta_info</span> <span class="o">?</span>
					<span class="n">part</span><span class="o">-&gt;</span><span class="n">bd_meta_info</span><span class="o">-&gt;</span><span class="nl">uuid</span> <span class="p">:</span> <span class="s">&quot;&quot;</span><span class="p">);</span>
			<span class="k">if</span> <span class="p">(</span><span class="n">is_part0</span><span class="p">)</span> <span class="p">{</span>
				<span class="k">if</span> <span class="p">(</span><span class="n">dev</span><span class="o">-&gt;</span><span class="n">parent</span> <span class="o">&amp;&amp;</span> <span class="n">dev</span><span class="o">-&gt;</span><span class="n">parent</span><span class="o">-&gt;</span><span class="n">driver</span><span class="p">)</span>
					<span class="n">printk</span><span class="p">(</span><span class="s">&quot; driver: %s</span><span class="se">\n</span><span class="s">&quot;</span><span class="p">,</span>
					      <span class="n">dev</span><span class="o">-&gt;</span><span class="n">parent</span><span class="o">-&gt;</span><span class="n">driver</span><span class="o">-&gt;</span><span class="n">name</span><span class="p">);</span>
				<span class="k">else</span>
...
<span class="p">{</span>
	...
	<span class="k">if</span> <span class="p">(</span><span class="n">iter</span><span class="p">)</span> <span class="p">{</span>
		...
		<span class="n">seqf</span><span class="o">-&gt;</span><span class="n">private</span> <span class="o">=</span> <span class="nb">NULL</span><span class="p">;</span>
	<span class="p">}</span>
<span class="p">}</span>
...
<span class="p">{</span>
	...
	<span class="k">while</span> <span class="p">((</span><span class="n">part</span> <span class="o">=</span> <span class="n">disk_part_iter_next</span><span class="p">(</span><span class="o">&amp;</span><span class="n">piter</span><span class="p">)))</span>
		<span class="n">seq_printf</span><span class="p">(</span><span class="n">seqf</span><span class="p">,</span> <span class="s">&quot;%4d  %7d %10llu %s</span><span class="se">\n</span><span class="s">&quot;</span><span class="p">,</span>
			   <span class="n">MAJOR</span><span class="p">(</span><span class="n">part</span><span class="o">-&gt;</span><span class="n">bd_dev</span><span class="p">),</span> <span class="n">MINOR</span><span class="p">(</span><span class="n">part</span><span class="o">-&gt;</span><span class="n">bd_dev</span><span class="p">),</span>
			   <span class="n">bdev_nr_sectors</span><span class="p">(</span><span class="n">part</span><span class="p">)</span> <span class="o">&gt;&gt;</span> <span class="mi">1</span><span class="p">,</span>
			   <span class="n">disk_name</span><span class="p">(</span><span class="n">sgp</span><span class="p">,</span> <span class="n">part</span><span class="o">-&gt;</span><span class="n">bd_partno</span><span class="p">,</span> <span class="n">buf</span><span class="p">));</span>
	<span class="n">disk_part_iter_exit</span><span class="p">(</span><span class="o">&amp;</span><span class="n">piter</span><span class="p">);</span>
...
<span class="k">static</span> <span class="kt">ssize_t</span> <span class="nf">disk_hidden_show</span><span class="p">(</span><span class="k">struct</span> <span class="n">device</span> <span class="o">*</span><span class="n">dev</span><span class="p">,</span>
				   <span class="k">struct</span> <span class="n">device_attribute</span> <span class="o">*</span><span class="n">attr</span><span class="p">,</span> <span class="kt">char</span> <span class="o">*</span><span class="n">buf</span><span class="p">)</span>
<span class="p">{</span>
	<span class="k">struct</span> <span class="n">gendisk</span> <span class="o">*</span><span class="n">disk</span> <span class="o">=</span> <span class="n">dev_to_disk</span><span class="p">(</span><span class="n">dev</span><span class="p">);</span>

	<span class="k">return</span> <span class="n">sprintf</span><span class="p">(</span><span class="n">buf</span><span class="p">,</span> <span class="s">&quot;%d</span><span class="se">\n</span><span class="s">&quot;</span><span class="p">,</span>
		       <span class="p">(</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">flags</span> <span class="o">&amp;</span> <span class="n">GENHD_FL_HIDDEN</span> <span class="o">?</span> <span class="mi">1</span> <span class="o">:</span> <span class="mi">0</span><span class="p">));</span>
<span class="p">}</span>
...
<span class="kt">ssize_t</span> <span class="nf">part_size_show</span><span class="p">(</span><span class="k">struct</span> <span class="n">device</span> <span class="o">*</span><span class="n">dev</span><span class="p">,</span>
		       <span class="k">struct</span> <span class="n">device_attribute</span> <span class="o">*</span><span class="n">attr</span><span class="p">,</span> <span class="kt">char</span> <span class="o">*</span><span class="n">buf</span><span class="p">)</span>
<span class="p">{</span>
	<span class="k">return</span> <span class="n">sprintf</span><span class="p">(</span><span class="n">buf</span><span class="p">,</span> <span class="s">&quot;%llu</span><span class="se">\n</span><span class="s">&quot;</span><span class="p">,</span> <span class="n">bdev_nr_sectors</span><span class="p">(</span><span class="n">dev_to_bdev</span><span class="p">(</span><span class="n">dev</span><span class="p">)));</span>
<span class="p">}</span>

<span class="kt">ssize_t</span> <span class="nf">part_stat_show</span><span class="p">(</span><span class="k">struct</span> <span class="n">device</span> <span class="o">*</span><span class="n">dev</span><span class="p">,</span>
		       <span class="k">struct</span> <span class="n">device_attribute</span> <span class="o">*</span><span class="n">attr</span><span class="p">,</span> <span class="kt">char</span> <span class="o">*</span><span class="n">buf</span><span class="p">)</span>
<span class="p">{</span>
	<span class="k">struct</span> <span class="n">block_device</span> <span class="o">*</span><span class="n">bdev</span> <span class="o">=</span> <span class="n">dev_to_bdev</span><span class="p">(</span><span class="n">dev</span><span class="p">);</span>
	<span class="k">struct</span> <span class="n">request_queue</span> <span class="o">*</span><span class="n">q</span> <span class="o">=</span> <span class="n">bdev</span><span class="o">-&gt;</span><span class="n">bd_disk</span><span class="o">-&gt;</span><span class="n">queue</span><span class="p">;</span>
	<span class="k">struct</span> <span class="n">disk_stats</span> <span class="n">stat</span><span class="p">;</span>
	<span class="kt">unsigned</span> <span class="kt">int</span> <span class="n">inflight</span><span class="p">;</span>

	<span class="n">part_stat_read_all</span><span class="p">(</span><span class="n">bdev</span><span class="p">,</span> <span class="o">&amp;</span><span class="n">stat</span><span class="p">);</span>
	<span class="k">if</span> <span class="p">(</span><span class="n">queue_is_mq</span><span class="p">(</span><span class="n">q</span><span class="p">))</span>
		<span class="n">inflight</span> <span class="o">=</span> <span class="n">blk_mq_in_flight</span><span class="p">(</span><span class="n">q</span><span class="p">,</span> <span class="n">bdev</span><span class="p">);</span>
	<span class="k">else</span>
		<span class="n">inflight</span> <span class="o">=</span> <span class="n">part_in_flight</span><span class="p">(</span><span class="n">bdev</span><span class="p">);</span>

	<span class="k">return</span> <span class="n">sprintf</span><span class="p">(</span><span class="n">buf</span><span class="p">,</span>
		<span class="s">&quot;%8lu %8lu %8llu %8u &quot;</span>
		<span class="s">&quot;%8lu %8lu %8llu %8u &quot;</span>
		<span class="s">&quot;%8u %8u %8u &quot;</span>
		<span class="s">&quot;%8lu %8lu %8llu %8u &quot;</span>
		<span class="s">&quot;%8lu %8u&quot;</span>
		<span class="s">&quot;</span><span class="se">\n</span><span class="s">&quot;</span><span class="p">,</span>
		<span class="n">stat</span><span class="p">.</span><span class="n">ios</span><span class="p">[</span><span class="n">STAT_READ</span><span class="p">],</span>
		<span class="n">stat</span><span class="p">.</span><span class="n">merges</span><span class="p">[</span><span class="n">STAT_READ</span><span class="p">],</span>
		<span class="p">(</span><span class="kt">unsigned</span> <span class="kt">long</span> <span class="kt">long</span><span class="p">)</span><span class="n">stat</span><span class="p">.</span><span class="n">sectors</span><span class="p">[</span><span class="n">STAT_READ</span><span class="p">],</span>
		<span class="p">(</span><span class="kt">unsigned</span> <span class="kt">int</span><span class="p">)</span><span class="n">div_u64</span><span class="p">(</span><span class="n">stat</span><span class="p">.</span><span class="n">nsecs</span><span class="p">[</span><span class="n">STAT_READ</span><span class="p">],</span> <span class="n">NSEC_PER_MSEC</span><span class="p">),</span>
		<span class="n">stat</span><span class="p">.</span><span class="n">ios</span><span class="p">[</span><span class="n">STAT_WRITE</span><span class="p">],</span>
		<span class="n">stat</span><span class="p">.</span><span class="n">merges</span><span class="p">[</span><span class="n">STAT_WRITE</span><span class="p">],</span>
		<span class="p">(</span><span class="kt">unsigned</span> <span class="kt">long</span> <span class="kt">long</span><span class="p">)</span><span class="n">stat</span><span class="p">.</span><span class="n">sectors</span><span class="p">[</span><span class="n">STAT_WRITE</span><span class="p">],</span>
		<span class="p">(</span><span class="kt">unsigned</span> <span class="kt">int</span><span class="p">)</span><span class="n">div_u64</span><span class="p">(</span><span class="n">stat</span><span class="p">.</span><span class="n">nsecs</span><span class="p">[</span><span class="n">STAT_WRITE</span><span class="p">],</span> <span class="n">NSEC_PER_MSEC</span><span class="p">),</span>
		<span class="n">inflight</span><span class="p">,</span>
		<span class="n">jiffies_to_msecs</span><span class="p">(</span><span class="n">stat</span><span class="p">.</span><span class="n">io_ticks</span><span class="p">),</span>
		<span class="p">(</span><span class="kt">unsigned</span> <span class="kt">int</span><span class="p">)</span><span class="n">div_u64</span><span class="p">(</span><span class="n">stat</span><span class="p">.</span><span class="n">nsecs</span><span class="p">[</span><span class="n">STAT_READ</span><span class="p">]</span> <span class="o">+</span>
				      <span class="n">stat</span><span class="p">.</span><span class="n">nsecs</span><span class="p">[</span><span class="n">STAT_WRITE</span><span class="p">]</span> <span class="o">+</span>
				      <span class="n">stat</span><span class="p">.</span><span class="n">nsecs</span><span class="p">[</span><span class="n">STAT_DISCARD</span><span class="p">]</span> <span class="o">+</span>
				      <span class="n">stat</span><span class="p">.</span><span class="n">nsecs</span><span class="p">[</span><span class="n">STAT_FLUSH</span><span class="p">],</span>
						<span class="n">NSEC_PER_MSEC</span><span class="p">),</span>
		<span class="n">stat</span><span class="p">.</span><span class="n">ios</span><span class="p">[</span><span class="n">STAT_DISCARD</span><span class="p">],</span>
		<span class="n">stat</span><span class="p">.</span><span class="n">merges</span><span class="p">[</span><span class="n">STAT_DISCARD</span><span class="p">],</span>
		<span class="p">(</span><span class="kt">unsigned</span> <span class="kt">long</span> <span class="kt">long</span><span class="p">)</span><span class="n">stat</span><span class="p">.</span><span class="n">sectors</span><span class="p">[</span><span class="n">STAT_DISCARD</span><span class="p">],</span>
		<span class="p">(</span><span class="kt">unsigned</span> <span class="kt">int</span><span class="p">)</span><span class="n">div_u64</span><span class="p">(</span><span class="n">stat</span><span class="p">.</span><span class="n">nsecs</span><span class="p">[</span><span class="n">STAT_DISCARD</span><span class="p">],</span> <span class="n">NSEC_PER_MSEC</span><span class="p">),</span>
		<span class="n">stat</span><span class="p">.</span><span class="n">ios</span><span class="p">[</span><span class="n">STAT_FLUSH</span><span class="p">],</span>
		<span class="p">(</span><span class="kt">unsigned</span> <span class="kt">int</span><span class="p">)</span><span class="n">div_u64</span><span class="p">(</span><span class="n">stat</span><span class="p">.</span><span class="n">nsecs</span><span class="p">[</span><span class="n">STAT_FLUSH</span><span class="p">],</span> <span class="n">NSEC_PER_MSEC</span><span class="p">));</span>
<span class="p">}</span>

<span class="kt">ssize_t</span> <span class="nf">part_inflight_show</span><span class="p">(</span><span class="k">struct</span> <span class="n">device</span> <span class="o">*</span><span class="n">dev</span><span class="p">,</span> <span class="k">struct</span> <span class="n">device_attribute</span> <span class="o">*</span><span class="n">attr</span><span class="p">,</span>
...
<span class="p">{</span>
	...
	<span class="k">if</span> <span class="p">(</span><span class="n">queue_is_mq</span><span class="p">(</span><span class="n">q</span><span class="p">))</span>
		<span class="n">blk_mq_in_flight_rw</span><span class="p">(</span><span class="n">q</span><span class="p">,</span> <span class="n">bdev</span><span class="p">,</span> <span class="n">inflight</span><span class="p">);</span>
	<span class="k">else</span>
		<span class="n">part_in_flight_rw</span><span class="p">(</span><span class="n">bdev</span><span class="p">,</span> <span class="n">inflight</span><span class="p">);</span>

	<span class="k">return</span> <span class="n">sprintf</span><span class="p">(</span><span class="n">buf</span><span class="p">,</span> <span class="s">&quot;%8u %8u</span><span class="se">\n</span><span class="s">&quot;</span><span class="p">,</span> <span class="n">inflight</span><span class="p">[</span><span class="mi">0</span><span class="p">],</span> <span class="n">inflight</span><span class="p">[</span><span class="mi">1</span><span class="p">]);</span>
<span class="p">}</span>
...
<span class="k">static</span> <span class="nf">DEVICE_ATTR</span><span class="p">(</span><span class="n">range</span><span class="p">,</span> <span class="mo">0444</span><span class="p">,</span> <span class="n">disk_range_show</span><span class="p">,</span> <span class="nb">NULL</span><span class="p">);</span>
<span class="k">static</span> <span class="nf">DEVICE_ATTR</span><span class="p">(</span><span class="n">ext_range</span><span class="p">,</span> <span class="mo">0444</span><span class="p">,</span> <span class="n">disk_ext_range_show</span><span class="p">,</span> <span class="nb">NULL</span><span class="p">);</span>
<span class="k">static</span> <span class="nf">DEVICE_ATTR</span><span class="p">(</span><span class="n">removable</span><span class="p">,</span> <span class="mo">0444</span><span class="p">,</span> <span class="n">disk_removable_show</span><span class="p">,</span> <span class="nb">NULL</span><span class="p">);</span>
<span class="k">static</span> <span class="nf">DEVICE_ATTR</span><span class="p">(</span><span class="n">hidden</span><span class="p">,</span> <span class="mo">0444</span><span class="p">,</span> <span class="n">disk_hidden_show</span><span class="p">,</span> <span class="nb">NULL</span><span class="p">);</span>
<span class="k">static</span> <span class="nf">DEVICE_ATTR</span><span class="p">(</span><span class="n">ro</span><span class="p">,</span> <span class="mo">0444</span><span class="p">,</span> <span class="n">disk_ro_show</span><span class="p">,</span> <span class="nb">NULL</span><span class="p">);</span>
<span class="k">static</span> <span class="nf">DEVICE_ATTR</span><span class="p">(</span><span class="n">size</span><span class="p">,</span> <span class="mo">0444</span><span class="p">,</span> <span class="n">part_size_show</span><span class="p">,</span> <span class="nb">NULL</span><span class="p">);</span>
<span class="k">static</span> <span class="nf">DEVICE_ATTR</span><span class="p">(</span><span class="n">alignment_offset</span><span class="p">,</span> <span class="mo">0444</span><span class="p">,</span> <span class="n">disk_alignment_offset_show</span><span class="p">,</span> <span class="nb">NULL</span><span class="p">);</span>
<span class="k">static</span> <span class="nf">DEVICE_ATTR</span><span class="p">(</span><span class="n">discard_alignment</span><span class="p">,</span> <span class="mo">0444</span><span class="p">,</span> <span class="n">disk_discard_alignment_show</span><span class="p">,</span> <span class="nb">NULL</span><span class="p">);</span>
<span class="k">static</span> <span class="nf">DEVICE_ATTR</span><span class="p">(</span><span class="n">capability</span><span class="p">,</span> <span class="mo">0444</span><span class="p">,</span> <span class="n">disk_capability_show</span><span class="p">,</span> <span class="nb">NULL</span><span class="p">);</span>
<span class="k">static</span> <span class="nf">DEVICE_ATTR</span><span class="p">(</span><span class="n">stat</span><span class="p">,</span> <span class="mo">0444</span><span class="p">,</span> <span class="n">part_stat_show</span><span class="p">,</span> <span class="nb">NULL</span><span class="p">);</span>
<span class="k">static</span> <span class="nf">DEVICE_ATTR</span><span class="p">(</span><span class="n">inflight</span><span class="p">,</span> <span class="mo">0444</span><span class="p">,</span> <span class="n">part_inflight_show</span><span class="p">,</span> <span class="nb">NULL</span><span class="p">);</span>
<span class="k">static</span> <span class="nf">DEVICE_ATTR</span><span class="p">(</span><span class="n">badblocks</span><span class="p">,</span> <span class="mo">0644</span><span class="p">,</span> <span class="n">disk_badblocks_show</span><span class="p">,</span> <span class="n">disk_badblocks_store</span><span class="p">);</span>

<span class="cp">#ifdef CONFIG_FAIL_MAKE_REQUEST</span>
<span class="kt">ssize_t</span> <span class="nf">part_fail_show</span><span class="p">(</span><span class="k">struct</span> <span class="n">device</span> <span class="o">*</span><span class="n">dev</span><span class="p">,</span>
		       <span class="k">struct</span> <span class="n">device_attribute</span> <span class="o">*</span><span class="n">attr</span><span class="p">,</span> <span class="kt">char</span> <span class="o">*</span><span class="n">buf</span><span class="p">)</span>
<span class="p">{</span>
	<span class="k">return</span> <span class="n">sprintf</span><span class="p">(</span><span class="n">buf</span><span class="p">,</span> <span class="s">&quot;%d</span><span class="se">\n</span><span class="s">&quot;</span><span class="p">,</span> <span class="n">dev_to_bdev</span><span class="p">(</span><span class="n">dev</span><span class="p">)</span><span class="o">-&gt;</span><span class="n">bd_make_it_fail</span><span class="p">);</span>
<span class="p">}</span>

<span class="kt">ssize_t</span> <span class="nf">part_fail_store</span><span class="p">(</span><span class="k">struct</span> <span class="n">device</span> <span class="o">*</span><span class="n">dev</span><span class="p">,</span>
			<span class="k">struct</span> <span class="n">device_attribute</span> <span class="o">*</span><span class="n">attr</span><span class="p">,</span>
			<span class="k">const</span> <span class="kt">char</span> <span class="o">*</span><span class="n">buf</span><span class="p">,</span> <span class="kt">size_t</span> <span class="n">count</span><span class="p">)</span>
<span class="p">{</span>
	<span class="kt">int</span> <span class="n">i</span><span class="p">;</span>

	<span class="k">if</span> <span class="p">(</span><span class="n">count</span> <span class="o">&gt;</span> <span class="mi">0</span> <span class="o">&amp;&amp;</span> <span class="n">sscanf</span><span class="p">(</span><span class="n">buf</span><span class="p">,</span> <span class="s">&quot;%d&quot;</span><span class="p">,</span> <span class="o">&amp;</span><span class="n">i</span><span class="p">)</span> <span class="o">&gt;</span> <span class="mi">0</span><span class="p">)</span>
		<span class="n">dev_to_bdev</span><span class="p">(</span><span class="n">dev</span><span class="p">)</span><span class="o">-&gt;</span><span class="n">bd_make_it_fail</span> <span class="o">=</span> <span class="n">i</span><span class="p">;</span>
...
<span class="k">static</span> <span class="k">struct</span> <span class="n">device_attribute</span> <span class="n">dev_attr_fail</span> <span class="o">=</span>
	<span class="n">__ATTR</span><span class="p">(</span><span class="n">make</span><span class="o">-</span><span class="n">it</span><span class="o">-</span><span class="n">fail</span><span class="p">,</span> <span class="mo">0644</span><span class="p">,</span> <span class="n">part_fail_show</span><span class="p">,</span> <span class="n">part_fail_store</span><span class="p">);</span>
...
<span class="k">static</span> <span class="k">struct</span> <span class="n">device_attribute</span> <span class="n">dev_attr_fail_timeout</span> <span class="o">=</span>
	<span class="n">__ATTR</span><span class="p">(</span><span class="n">io</span><span class="o">-</span><span class="n">timeout</span><span class="o">-</span><span class="n">fail</span><span class="p">,</span> <span class="mo">0644</span><span class="p">,</span> <span class="n">part_timeout_show</span><span class="p">,</span> <span class="n">part_timeout_store</span><span class="p">);</span>
<span class="cp">#endif</span>
...
<span class="k">static</span> <span class="k">struct</span> <span class="n">attribute</span> <span class="o">*</span><span class="n">disk_attrs</span><span class="p">[]</span> <span class="o">=</span> <span class="p">{</span>
	...
	<span class="o">&amp;</span><span class="n">dev_attr_hidden</span><span class="p">.</span><span class="n">attr</span><span class="p">,</span>
	...
	<span class="o">&amp;</span><span class="n">dev_attr_badblocks</span><span class="p">.</span><span class="n">attr</span><span class="p">,</span>
<span class="cp">#ifdef CONFIG_FAIL_MAKE_REQUEST</span>
...
<span class="k">static</span> <span class="n">umode_t</span> <span class="nf">disk_visible</span><span class="p">(</span><span class="k">struct</span> <span class="n">kobject</span> <span class="o">*</span><span class="n">kobj</span><span class="p">,</span> <span class="k">struct</span> <span class="n">attribute</span> <span class="o">*</span><span class="n">a</span><span class="p">,</span> <span class="kt">int</span> <span class="n">n</span><span class="p">)</span>
<span class="p">{</span>
	<span class="k">struct</span> <span class="n">device</span> <span class="o">*</span><span class="n">dev</span> <span class="o">=</span> <span class="n">container_of</span><span class="p">(</span><span class="n">kobj</span><span class="p">,</span> <span class="n">typeof</span><span class="p">(</span><span class="o">*</span><span class="n">dev</span><span class="p">),</span> <span class="n">kobj</span><span class="p">);</span>
	<span class="k">struct</span> <span class="n">gendisk</span> <span class="o">*</span><span class="n">disk</span> <span class="o">=</span> <span class="n">dev_to_disk</span><span class="p">(</span><span class="n">dev</span><span class="p">);</span>

	<span class="k">if</span> <span class="p">(</span><span class="n">a</span> <span class="o">==</span> <span class="o">&amp;</span><span class="n">dev_attr_badblocks</span><span class="p">.</span><span class="n">attr</span> <span class="o">&amp;&amp;</span> <span class="o">!</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">bb</span><span class="p">)</span>
		<span class="k">return</span> <span class="mi">0</span><span class="p">;</span>
...
<span class="k">static</span> <span class="k">struct</span> <span class="n">attribute_group</span> <span class="n">disk_attr_group</span> <span class="o">=</span> <span class="p">{</span>
	...
	<span class="p">.</span><span class="n">is_visible</span> <span class="o">=</span> <span class="n">disk_visible</span><span class="p">,</span>
<span class="p">};</span>
...
<span class="cm"> * Matching bd_mutex locked or the caller is the only user of @disk.</span>
<span class="cm"> */</span>
...
<span class="p">{</span>
	<span class="k">struct</span> <span class="n">disk_part_tbl</span> <span class="o">*</span><span class="n">old_ptbl</span> <span class="o">=</span>
		<span class="n">rcu_dereference_protected</span><span class="p">(</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">part_tbl</span><span class="p">,</span> <span class="mi">1</span><span class="p">);</span>
...
<span class="p">{</span>
	<span class="k">struct</span> <span class="n">disk_part_tbl</span> <span class="o">*</span><span class="n">old_ptbl</span> <span class="o">=</span>
		<span class="n">rcu_dereference_protected</span><span class="p">(</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">part_tbl</span><span class="p">,</span> <span class="mi">1</span><span class="p">);</span>
	<span class="k">struct</span> <span class="n">disk_part_tbl</span> <span class="o">*</span><span class="n">new_ptbl</span><span class="p">;</span>
	<span class="kt">int</span> <span class="n">len</span> <span class="o">=</span> <span class="n">old_ptbl</span> <span class="o">?</span> <span class="n">old_ptbl</span><span class="o">-&gt;</span><span class="nl">len</span> <span class="p">:</span> <span class="mi">0</span><span class="p">;</span>
	<span class="kt">int</span> <span class="n">i</span><span class="p">,</span> <span class="n">target</span><span class="p">;</span>

	<span class="cm">/*</span>
<span class="cm">	 * check for int overflow, since we can get here from blkpg_ioctl()</span>
<span class="cm">	 * with a user passed &#39;partno&#39;.</span>
<span class="cm">	 */</span>
	<span class="n">target</span> <span class="o">=</span> <span class="n">partno</span> <span class="o">+</span> <span class="mi">1</span><span class="p">;</span>
	...
	<span class="n">new_ptbl</span> <span class="o">=</span> <span class="n">kzalloc_node</span><span class="p">(</span><span class="n">struct_size</span><span class="p">(</span><span class="n">new_ptbl</span><span class="p">,</span> <span class="n">part</span><span class="p">,</span> <span class="n">target</span><span class="p">),</span> <span class="n">GFP_KERNEL</span><span class="p">,</span>
				<span class="n">disk</span><span class="o">-&gt;</span><span class="n">node_id</span><span class="p">);</span>
...
<span class="cm">/**</span>
<span class="cm"> * disk_release - releases all allocated resources of the gendisk</span>
<span class="cm"> * @dev: the device representing this disk</span>
<span class="cm"> *</span>
<span class="cm"> * This function releases all allocated resources of the gendisk.</span>
<span class="cm"> *</span>
<span class="cm"> * Drivers which used __device_add_disk() have a gendisk with a request_queue</span>
<span class="cm"> * assigned. Since the request_queue sits on top of the gendisk for these</span>
<span class="cm"> * drivers we also call blk_put_queue() for them, and we expect the</span>
<span class="cm"> * request_queue refcount to reach 0 at this point, and so the request_queue</span>
<span class="cm"> * will also be freed prior to the disk.</span>
<span class="cm"> *</span>
<span class="cm"> * Context: can sleep</span>
<span class="cm"> */</span>
...
<span class="p">{</span>
	...
	<span class="n">blk_free_devt</span><span class="p">(</span><span class="n">dev</span><span class="o">-&gt;</span><span class="n">devt</span><span class="p">);</span>
	...
	<span class="n">bdput</span><span class="p">(</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">part0</span><span class="p">);</span>
...
<span class="p">{</span>
	...
	<span class="k">if</span> <span class="p">(</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">fops</span><span class="o">-&gt;</span><span class="n">devnode</span><span class="p">)</span>
		<span class="k">return</span> <span class="n">disk</span><span class="o">-&gt;</span><span class="n">fops</span><span class="o">-&gt;</span><span class="n">devnode</span><span class="p">(</span><span class="n">disk</span><span class="p">,</span> <span class="n">mode</span><span class="p">);</span>
	<span class="k">return</span> <span class="nb">NULL</span><span class="p">;</span>
<span class="p">}</span>

<span class="k">const</span> <span class="k">struct</span> <span class="n">device_type</span> <span class="n">disk_type</span> <span class="o">=</span> <span class="p">{</span>
...
<span class="p">{</span>
	...
	<span class="k">struct</span> <span class="n">disk_part_iter</span> <span class="n">piter</span><span class="p">;</span>
	<span class="k">struct</span> <span class="n">block_device</span> <span class="o">*</span><span class="n">hd</span><span class="p">;</span>
	<span class="kt">char</span> <span class="n">buf</span><span class="p">[</span><span class="n">BDEVNAME_SIZE</span><span class="p">];</span>
	<span class="kt">unsigned</span> <span class="kt">int</span> <span class="n">inflight</span><span class="p">;</span>
	<span class="k">struct</span> <span class="n">disk_stats</span> <span class="n">stat</span><span class="p">;</span>
...
<span class="cm">	*/</span>
	...
	<span class="k">while</span> <span class="p">((</span><span class="n">hd</span> <span class="o">=</span> <span class="n">disk_part_iter_next</span><span class="p">(</span><span class="o">&amp;</span><span class="n">piter</span><span class="p">)))</span> <span class="p">{</span>
		<span class="n">part_stat_read_all</span><span class="p">(</span><span class="n">hd</span><span class="p">,</span> <span class="o">&amp;</span><span class="n">stat</span><span class="p">);</span>
		<span class="k">if</span> <span class="p">(</span><span class="n">queue_is_mq</span><span class="p">(</span><span class="n">gp</span><span class="o">-&gt;</span><span class="n">queue</span><span class="p">))</span>
			<span class="n">inflight</span> <span class="o">=</span> <span class="n">blk_mq_in_flight</span><span class="p">(</span><span class="n">gp</span><span class="o">-&gt;</span><span class="n">queue</span><span class="p">,</span> <span class="n">hd</span><span class="p">);</span>
		<span class="k">else</span>
			<span class="n">inflight</span> <span class="o">=</span> <span class="n">part_in_flight</span><span class="p">(</span><span class="n">hd</span><span class="p">);</span>

		<span class="n">seq_printf</span><span class="p">(</span><span class="n">seqf</span><span class="p">,</span> <span class="s">&quot;%4d %7d %s &quot;</span>
			   <span class="s">&quot;%lu %lu %lu %u &quot;</span>
			   <span class="s">&quot;%lu %lu %lu %u &quot;</span>
			   <span class="s">&quot;%u %u %u &quot;</span>
			   <span class="s">&quot;%lu %lu %lu %u &quot;</span>
			   <span class="s">&quot;%lu %u&quot;</span>
			   <span class="s">&quot;</span><span class="se">\n</span><span class="s">&quot;</span><span class="p">,</span>
			   <span class="n">MAJOR</span><span class="p">(</span><span class="n">hd</span><span class="o">-&gt;</span><span class="n">bd_dev</span><span class="p">),</span> <span class="n">MINOR</span><span class="p">(</span><span class="n">hd</span><span class="o">-&gt;</span><span class="n">bd_dev</span><span class="p">),</span>
			   <span class="n">disk_name</span><span class="p">(</span><span class="n">gp</span><span class="p">,</span> <span class="n">hd</span><span class="o">-&gt;</span><span class="n">bd_partno</span><span class="p">,</span> <span class="n">buf</span><span class="p">),</span>
			   <span class="n">stat</span><span class="p">.</span><span class="n">ios</span><span class="p">[</span><span class="n">STAT_READ</span><span class="p">],</span>
			   <span class="n">stat</span><span class="p">.</span><span class="n">merges</span><span class="p">[</span><span class="n">STAT_READ</span><span class="p">],</span>
			   <span class="n">stat</span><span class="p">.</span><span class="n">sectors</span><span class="p">[</span><span class="n">STAT_READ</span><span class="p">],</span>
			   <span class="p">(</span><span class="kt">unsigned</span> <span class="kt">int</span><span class="p">)</span><span class="n">div_u64</span><span class="p">(</span><span class="n">stat</span><span class="p">.</span><span class="n">nsecs</span><span class="p">[</span><span class="n">STAT_READ</span><span class="p">],</span>
							<span class="n">NSEC_PER_MSEC</span><span class="p">),</span>
			   <span class="n">stat</span><span class="p">.</span><span class="n">ios</span><span class="p">[</span><span class="n">STAT_WRITE</span><span class="p">],</span>
			   <span class="n">stat</span><span class="p">.</span><span class="n">merges</span><span class="p">[</span><span class="n">STAT_WRITE</span><span class="p">],</span>
			   <span class="n">stat</span><span class="p">.</span><span class="n">sectors</span><span class="p">[</span><span class="n">STAT_WRITE</span><span class="p">],</span>
			   <span class="p">(</span><span class="kt">unsigned</span> <span class="kt">int</span><span class="p">)</span><span class="n">div_u64</span><span class="p">(</span><span class="n">stat</span><span class="p">.</span><span class="n">nsecs</span><span class="p">[</span><span class="n">STAT_WRITE</span><span class="p">],</span>
							<span class="n">NSEC_PER_MSEC</span><span class="p">),</span>
			   <span class="n">inflight</span><span class="p">,</span>
			   <span class="n">jiffies_to_msecs</span><span class="p">(</span><span class="n">stat</span><span class="p">.</span><span class="n">io_ticks</span><span class="p">),</span>
			   <span class="p">(</span><span class="kt">unsigned</span> <span class="kt">int</span><span class="p">)</span><span class="n">div_u64</span><span class="p">(</span><span class="n">stat</span><span class="p">.</span><span class="n">nsecs</span><span class="p">[</span><span class="n">STAT_READ</span><span class="p">]</span> <span class="o">+</span>
			   ...
			   <span class="n">stat</span><span class="p">.</span><span class="n">ios</span><span class="p">[</span><span class="n">STAT_DISCARD</span><span class="p">],</span>
			   <span class="n">stat</span><span class="p">.</span><span class="n">merges</span><span class="p">[</span><span class="n">STAT_DISCARD</span><span class="p">],</span>
			   <span class="n">stat</span><span class="p">.</span><span class="n">sectors</span><span class="p">[</span><span class="n">STAT_DISCARD</span><span class="p">],</span>
			   <span class="p">(</span><span class="kt">unsigned</span> <span class="kt">int</span><span class="p">)</span><span class="n">div_u64</span><span class="p">(</span><span class="n">stat</span><span class="p">.</span><span class="n">nsecs</span><span class="p">[</span><span class="n">STAT_DISCARD</span><span class="p">],</span>
						 <span class="n">NSEC_PER_MSEC</span><span class="p">),</span>
			   <span class="n">stat</span><span class="p">.</span><span class="n">ios</span><span class="p">[</span><span class="n">STAT_FLUSH</span><span class="p">],</span>
			   <span class="p">(</span><span class="kt">unsigned</span> <span class="kt">int</span><span class="p">)</span><span class="n">div_u64</span><span class="p">(</span><span class="n">stat</span><span class="p">.</span><span class="n">nsecs</span><span class="p">[</span><span class="n">STAT_FLUSH</span><span class="p">],</span>
						 <span class="n">NSEC_PER_MSEC</span><span class="p">)</span>
			<span class="p">);</span>
	<span class="p">}</span>
	<span class="n">disk_part_iter_exit</span><span class="p">(</span><span class="o">&amp;</span><span class="n">piter</span><span class="p">);</span>
...
<span class="p">{</span>
	<span class="n">proc_create_seq</span><span class="p">(</span><span class="s">&quot;diskstats&quot;</span><span class="p">,</span> <span class="mi">0</span><span class="p">,</span> <span class="nb">NULL</span><span class="p">,</span> <span class="o">&amp;</span><span class="n">diskstats_op</span><span class="p">);</span>
	<span class="n">proc_create_seq</span><span class="p">(</span><span class="s">&quot;partitions&quot;</span><span class="p">,</span> <span class="mi">0</span><span class="p">,</span> <span class="nb">NULL</span><span class="p">,</span> <span class="o">&amp;</span><span class="n">partitions_op</span><span class="p">);</span>
	<span class="k">return</span> <span class="mi">0</span><span class="p">;</span>
<span class="p">}</span>
<span class="n">module_init</span><span class="p">(</span><span class="n">proc_genhd_init</span><span class="p">);</span>
<span class="cp">#endif </span><span class="cm">/* CONFIG_PROC_FS */</span><span class="cp"></span>

<span class="kt">dev_t</span> <span class="nf">blk_lookup_devt</span><span class="p">(</span><span class="k">const</span> <span class="kt">char</span> <span class="o">*</span><span class="n">name</span><span class="p">,</span> <span class="kt">int</span> <span class="n">partno</span><span class="p">)</span>
<span class="p">{</span>
	<span class="kt">dev_t</span> <span class="n">devt</span> <span class="o">=</span> <span class="n">MKDEV</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="mi">0</span><span class="p">);</span>
	<span class="k">struct</span> <span class="n">class_dev_iter</span> <span class="n">iter</span><span class="p">;</span>
	<span class="k">struct</span> <span class="n">device</span> <span class="o">*</span><span class="n">dev</span><span class="p">;</span>
...
<span class="cm">			 */</span>
			...
			<span class="k">break</span><span class="p">;</span>
		<span class="p">}</span>
		<span class="n">part</span> <span class="o">=</span> <span class="n">bdget_disk</span><span class="p">(</span><span class="n">disk</span><span class="p">,</span> <span class="n">partno</span><span class="p">);</span>
		<span class="k">if</span> <span class="p">(</span><span class="n">part</span><span class="p">)</span> <span class="p">{</span>
			<span class="n">devt</span> <span class="o">=</span> <span class="n">part</span><span class="o">-&gt;</span><span class="n">bd_dev</span><span class="p">;</span>
			<span class="n">bdput</span><span class="p">(</span><span class="n">part</span><span class="p">);</span>
			<span class="k">break</span><span class="p">;</span>
		<span class="p">}</span>
	<span class="p">}</span>
	<span class="n">class_dev_iter_exit</span><span class="p">(</span><span class="o">&amp;</span><span class="n">iter</span><span class="p">);</span>
...
<span class="k">struct</span> <span class="n">gendisk</span> <span class="o">*</span><span class="nf">__alloc_disk_node</span><span class="p">(</span><span class="kt">int</span> <span class="n">minors</span><span class="p">,</span> <span class="kt">int</span> <span class="n">node_id</span><span class="p">)</span>
<span class="p">{</span>
	<span class="k">struct</span> <span class="n">gendisk</span> <span class="o">*</span><span class="n">disk</span><span class="p">;</span>
	<span class="k">struct</span> <span class="n">disk_part_tbl</span> <span class="o">*</span><span class="n">ptbl</span><span class="p">;</span>

	<span class="k">if</span> <span class="p">(</span><span class="n">minors</span> <span class="o">&gt;</span> <span class="n">DISK_MAX_PARTS</span><span class="p">)</span> <span class="p">{</span>
		<span class="n">printk</span><span class="p">(</span><span class="n">KERN_ERR</span>
			<span class="s">&quot;block: can&#39;t allocate more than %d partitions</span><span class="se">\n</span><span class="s">&quot;</span><span class="p">,</span>
			<span class="n">DISK_MAX_PARTS</span><span class="p">);</span>
		<span class="n">minors</span> <span class="o">=</span> <span class="n">DISK_MAX_PARTS</span><span class="p">;</span>
	<span class="p">}</span>

	<span class="n">disk</span> <span class="o">=</span> <span class="n">kzalloc_node</span><span class="p">(</span><span class="k">sizeof</span><span class="p">(</span><span class="k">struct</span> <span class="n">gendisk</span><span class="p">),</span> <span class="n">GFP_KERNEL</span><span class="p">,</span> <span class="n">node_id</span><span class="p">);</span>
	<span class="k">if</span> <span class="p">(</span><span class="o">!</span><span class="n">disk</span><span class="p">)</span>
		<span class="k">return</span> <span class="nb">NULL</span><span class="p">;</span>

	<span class="n">disk</span><span class="o">-&gt;</span><span class="n">part0</span> <span class="o">=</span> <span class="n">bdev_alloc</span><span class="p">(</span><span class="n">disk</span><span class="p">,</span> <span class="mi">0</span><span class="p">);</span>
	<span class="k">if</span> <span class="p">(</span><span class="o">!</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">part0</span><span class="p">)</span>
	...
	<span class="k">if</span> <span class="p">(</span><span class="n">disk_expand_part_tbl</span><span class="p">(</span><span class="n">disk</span><span class="p">,</span> <span class="mi">0</span><span class="p">))</span>
		<span class="k">goto</span> <span class="n">out_bdput</span><span class="p">;</span>

	<span class="n">ptbl</span> <span class="o">=</span> <span class="n">rcu_dereference_protected</span><span class="p">(</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">part_tbl</span><span class="p">,</span> <span class="mi">1</span><span class="p">);</span>
	<span class="n">rcu_assign_pointer</span><span class="p">(</span><span class="n">ptbl</span><span class="o">-&gt;</span><span class="n">part</span><span class="p">[</span><span class="mi">0</span><span class="p">],</span> <span class="n">disk</span><span class="o">-&gt;</span><span class="n">part0</span><span class="p">);</span>
...
<span class="nl">out_bdput</span><span class="p">:</span>
	<span class="n">bdput</span><span class="p">(</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">part0</span><span class="p">);</span>
<span class="nl">out_free_disk</span><span class="p">:</span>
	<span class="n">kfree</span><span class="p">(</span><span class="n">disk</span><span class="p">);</span>
	<span class="k">return</span> <span class="nb">NULL</span><span class="p">;</span>
<span class="p">}</span>
<span class="n">EXPORT_SYMBOL</span><span class="p">(</span><span class="n">__alloc_disk_node</span><span class="p">);</span>

<span class="cm">/**</span>
<span class="cm"> * put_disk - decrements the gendisk refcount</span>
<span class="cm"> * @disk: the struct gendisk to decrement the refcount for</span>
<span class="cm"> *</span>
<span class="cm"> * This decrements the refcount for the struct gendisk. When this reaches 0</span>
<span class="cm"> * we&#39;ll have disk_release() called.</span>
<span class="cm"> *</span>
<span class="cm"> * Context: Any context, but the last reference must not be dropped from</span>
<span class="cm"> *          atomic context.</span>
<span class="cm"> */</span>
...
<span class="p">{</span>
	<span class="k">if</span> <span class="p">(</span><span class="n">disk</span><span class="p">)</span>
		<span class="n">put_device</span><span class="p">(</span><span class="n">disk_to_dev</span><span class="p">(</span><span class="n">disk</span><span class="p">));</span>
<span class="p">}</span>
...
<span class="p">{</span>
	...
	<span class="k">if</span> <span class="p">(</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">part0</span><span class="o">-&gt;</span><span class="n">bd_read_only</span> <span class="o">!=</span> <span class="n">flag</span><span class="p">)</span> <span class="p">{</span>
		...
		<span class="n">disk</span><span class="o">-&gt;</span><span class="n">part0</span><span class="o">-&gt;</span><span class="n">bd_read_only</span> <span class="o">=</span> <span class="n">flag</span><span class="p">;</span>
	<span class="p">}</span>
	...
	<span class="k">while</span> <span class="p">((</span><span class="n">part</span> <span class="o">=</span> <span class="n">disk_part_iter_next</span><span class="p">(</span><span class="o">&amp;</span><span class="n">piter</span><span class="p">)))</span>
		<span class="n">part</span><span class="o">-&gt;</span><span class="n">bd_read_only</span> <span class="o">=</span> <span class="n">flag</span><span class="p">;</span>
	<span class="n">disk_part_iter_exit</span><span class="p">(</span><span class="o">&amp;</span><span class="n">piter</span><span class="p">);</span>
<span class="p">}</span>
...
<span class="p">{</span>
	<span class="k">if</span> <span class="p">(</span><span class="o">!</span><span class="n">bdev</span><span class="p">)</span>
		<span class="k">return</span> <span class="mi">0</span><span class="p">;</span>
	<span class="k">return</span> <span class="n">bdev</span><span class="o">-&gt;</span><span class="n">bd_read_only</span><span class="p">;</span>
<span class="p">}</span>
...
<span class="k">static</span> <span class="nf">DEFINE_MUTEX</span><span class="p">(</span><span class="n">disk_events_mutex</span><span class="p">);</span>
<span class="k">static</span> <span class="nf">LIST_HEAD</span><span class="p">(</span><span class="n">disk_events</span><span class="p">);</span>

<span class="cm">/* disable in-kernel polling by default */</span>
<span class="k">static</span> <span class="kt">unsigned</span> <span class="kt">long</span> <span class="n">disk_events_dfl_poll_msecs</span><span class="p">;</span>
...
<span class="cm">	 * the default is being used, poll if the POLL flag is set.</span>
<span class="cm">	 */</span>
	...
	<span class="k">else</span> <span class="k">if</span> <span class="p">(</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">event_flags</span> <span class="o">&amp;</span> <span class="n">DISK_EVENT_FLAG_POLL</span><span class="p">)</span>
...
<span class="p">{</span>
	...
	<span class="kt">bool</span> <span class="n">cancel</span><span class="p">;</span>
...
<span class="k">static</span> <span class="kt">void</span> <span class="nf">__disk_unblock_events</span><span class="p">(</span><span class="k">struct</span> <span class="n">gendisk</span> <span class="o">*</span><span class="n">disk</span><span class="p">,</span> <span class="kt">bool</span> <span class="n">check_now</span><span class="p">)</span>
<span class="p">{</span>
	<span class="k">struct</span> <span class="n">disk_events</span> <span class="o">*</span><span class="n">ev</span> <span class="o">=</span> <span class="n">disk</span><span class="o">-&gt;</span><span class="n">ev</span><span class="p">;</span>
	...
	<span class="k">if</span> <span class="p">(</span><span class="n">check_now</span><span class="p">)</span>
		<span class="n">queue_delayed_work</span><span class="p">(</span><span class="n">system_freezable_power_efficient_wq</span><span class="p">,</span>
				<span class="o">&amp;</span><span class="n">ev</span><span class="o">-&gt;</span><span class="n">dwork</span><span class="p">,</span> <span class="mi">0</span><span class="p">);</span>
	<span class="k">else</span> <span class="k">if</span> <span class="p">(</span><span class="n">intv</span><span class="p">)</span>
		<span class="n">queue_delayed_work</span><span class="p">(</span><span class="n">system_freezable_power_efficient_wq</span><span class="p">,</span>
				<span class="o">&amp;</span><span class="n">ev</span><span class="o">-&gt;</span><span class="n">dwork</span><span class="p">,</span> <span class="n">intv</span><span class="p">);</span>
<span class="nl">out_unlock</span><span class="p">:</span>
	<span class="n">spin_unlock_irqrestore</span><span class="p">(</span><span class="o">&amp;</span><span class="n">ev</span><span class="o">-&gt;</span><span class="n">lock</span><span class="p">,</span> <span class="n">flags</span><span class="p">);</span>
<span class="p">}</span>
...
<span class="p">{</span>
	...
	<span class="k">if</span> <span class="p">(</span><span class="o">!</span><span class="n">ev</span><span class="o">-&gt;</span><span class="n">block</span><span class="p">)</span>
		<span class="n">mod_delayed_work</span><span class="p">(</span><span class="n">system_freezable_power_efficient_wq</span><span class="p">,</span>
				<span class="o">&amp;</span><span class="n">ev</span><span class="o">-&gt;</span><span class="n">dwork</span><span class="p">,</span> <span class="mi">0</span><span class="p">);</span>
...
<span class="cm"> * @mask: mask of events to be fetched and cleared</span>
<span class="cm"> *</span>
...
<span class="p">{</span>
	...
	<span class="kt">unsigned</span> <span class="kt">int</span> <span class="n">clearing</span> <span class="o">=</span> <span class="n">mask</span><span class="p">;</span>
	...
	<span class="cm">/*</span>
<span class="cm">	 * store the union of mask and ev-&gt;clearing on the stack so that the</span>
<span class="cm">	 * race with disk_flush_events does not cause ambiguity (ev-&gt;clearing</span>
<span class="cm">	 * can still be modified even if events are blocked).</span>
<span class="cm">	 */</span>
	<span class="n">spin_lock_irq</span><span class="p">(</span><span class="o">&amp;</span><span class="n">ev</span><span class="o">-&gt;</span><span class="n">lock</span><span class="p">);</span>
	<span class="n">clearing</span> <span class="o">|=</span> <span class="n">ev</span><span class="o">-&gt;</span><span class="n">clearing</span><span class="p">;</span>
	<span class="n">ev</span><span class="o">-&gt;</span><span class="n">clearing</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span>
	<span class="n">spin_unlock_irq</span><span class="p">(</span><span class="o">&amp;</span><span class="n">ev</span><span class="o">-&gt;</span><span class="n">lock</span><span class="p">);</span>

	<span class="n">disk_check_events</span><span class="p">(</span><span class="n">ev</span><span class="p">,</span> <span class="o">&amp;</span><span class="n">clearing</span><span class="p">);</span>
	<span class="cm">/*</span>
<span class="cm">	 * if ev-&gt;clearing is not 0, the disk_flush_events got called in the</span>
<span class="cm">	 * middle of this function, so we want to run the workfn without delay.</span>
<span class="cm">	 */</span>
	<span class="n">__disk_unblock_events</span><span class="p">(</span><span class="n">disk</span><span class="p">,</span> <span class="n">ev</span><span class="o">-&gt;</span><span class="n">clearing</span> <span class="o">?</span> <span class="nb">true</span> <span class="o">:</span> <span class="nb">false</span><span class="p">);</span>
	...
	<span class="n">spin_unlock_irq</span><span class="p">(</span><span class="o">&amp;</span><span class="n">ev</span><span class="o">-&gt;</span><span class="n">lock</span><span class="p">);</span>
	<span class="n">WARN_ON_ONCE</span><span class="p">(</span><span class="n">clearing</span> <span class="o">&amp;</span> <span class="n">mask</span><span class="p">);</span>

	<span class="k">return</span> <span class="n">pending</span><span class="p">;</span>
<span class="p">}</span>

<span class="cm">/**</span>
<span class="cm"> * bdev_check_media_change - check if a removable media has been changed</span>
<span class="cm"> * @bdev: block device to check</span>
<span class="cm"> *</span>
<span class="cm"> * Check whether a removable media has been changed, and attempt to free all</span>
<span class="cm"> * dentries and inodes and invalidates all block device page cache entries in</span>
<span class="cm"> * that case.</span>
<span class="cm"> *</span>
<span class="cm"> * Returns %true if the block device changed, or %false if not.</span>
<span class="cm"> */</span>
<span class="kt">bool</span> <span class="nf">bdev_check_media_change</span><span class="p">(</span><span class="k">struct</span> <span class="n">block_device</span> <span class="o">*</span><span class="n">bdev</span><span class="p">)</span>
<span class="p">{</span>
	<span class="kt">unsigned</span> <span class="kt">int</span> <span class="n">events</span><span class="p">;</span>

	<span class="n">events</span> <span class="o">=</span> <span class="n">disk_clear_events</span><span class="p">(</span><span class="n">bdev</span><span class="o">-&gt;</span><span class="n">bd_disk</span><span class="p">,</span> <span class="n">DISK_EVENT_MEDIA_CHANGE</span> <span class="o">|</span>
				   <span class="n">DISK_EVENT_EJECT_REQUEST</span><span class="p">);</span>
	<span class="k">if</span> <span class="p">(</span><span class="o">!</span><span class="p">(</span><span class="n">events</span> <span class="o">&amp;</span> <span class="n">DISK_EVENT_MEDIA_CHANGE</span><span class="p">))</span>
		<span class="k">return</span> <span class="nb">false</span><span class="p">;</span>

	<span class="k">if</span> <span class="p">(</span><span class="n">__invalidate_device</span><span class="p">(</span><span class="n">bdev</span><span class="p">,</span> <span class="nb">true</span><span class="p">))</span>
		<span class="n">pr_warn</span><span class="p">(</span><span class="s">&quot;VFS: busy inodes on changed media %s</span><span class="se">\n</span><span class="s">&quot;</span><span class="p">,</span>
			<span class="n">bdev</span><span class="o">-&gt;</span><span class="n">bd_disk</span><span class="o">-&gt;</span><span class="n">disk_name</span><span class="p">);</span>
	<span class="n">set_bit</span><span class="p">(</span><span class="n">GD_NEED_PART_SCAN</span><span class="p">,</span> <span class="o">&amp;</span><span class="n">bdev</span><span class="o">-&gt;</span><span class="n">bd_disk</span><span class="o">-&gt;</span><span class="n">state</span><span class="p">);</span>
	<span class="k">return</span> <span class="nb">true</span><span class="p">;</span>
<span class="p">}</span>
<span class="n">EXPORT_SYMBOL</span><span class="p">(</span><span class="n">bdev_check_media_change</span><span class="p">);</span>

<span class="cm">/*</span>
<span class="cm"> * Separate this part out so that a different pointer for clearing_ptr can be</span>
<span class="cm"> * passed in for disk_clear_events.</span>
<span class="cm"> */</span>
...
<span class="p">{</span>
	...
	<span class="n">disk_check_events</span><span class="p">(</span><span class="n">ev</span><span class="p">,</span> <span class="o">&amp;</span><span class="n">ev</span><span class="o">-&gt;</span><span class="n">clearing</span><span class="p">);</span>
<span class="p">}</span>
...
<span class="p">{</span>
	...
	<span class="kt">unsigned</span> <span class="kt">int</span> <span class="n">clearing</span> <span class="o">=</span> <span class="o">*</span><span class="n">clearing_ptr</span><span class="p">;</span>
	<span class="kt">unsigned</span> <span class="kt">int</span> <span class="n">events</span><span class="p">;</span>
	<span class="kt">unsigned</span> <span class="kt">long</span> <span class="n">intv</span><span class="p">;</span>
	...
	<span class="o">*</span><span class="n">clearing_ptr</span> <span class="o">&amp;=</span> <span class="o">~</span><span class="n">clearing</span><span class="p">;</span>
...
<span class="cm">	 * @disk-&gt;events are reported, and only if DISK_EVENT_FLAG_UEVENT</span>
<span class="cm">	 * is set. Otherwise, events are processed internally but never</span>
<span class="cm">	 * get reported to userland.</span>
<span class="cm">	 */</span>
	<span class="k">for</span> <span class="p">(</span><span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">ARRAY_SIZE</span><span class="p">(</span><span class="n">disk_uevents</span><span class="p">);</span> <span class="n">i</span><span class="o">++</span><span class="p">)</span>
		<span class="k">if</span> <span class="p">((</span><span class="n">events</span> <span class="o">&amp;</span> <span class="n">disk</span><span class="o">-&gt;</span><span class="n">events</span> <span class="o">&amp;</span> <span class="p">(</span><span class="mi">1</span> <span class="o">&lt;&lt;</span> <span class="n">i</span><span class="p">))</span> <span class="o">&amp;&amp;</span>
		    <span class="p">(</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">event_flags</span> <span class="o">&amp;</span> <span class="n">DISK_EVENT_FLAG_UEVENT</span><span class="p">))</span>
...
<span class="cm"> *			  (always empty, only for backwards compatibility)</span>
...
<span class="p">{</span>
	...
	<span class="k">if</span> <span class="p">(</span><span class="o">!</span><span class="p">(</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">event_flags</span> <span class="o">&amp;</span> <span class="n">DISK_EVENT_FLAG_UEVENT</span><span class="p">))</span>
		<span class="k">return</span> <span class="mi">0</span><span class="p">;</span>
...
<span class="k">static</span> <span class="k">const</span> <span class="nf">DEVICE_ATTR</span><span class="p">(</span><span class="n">events</span><span class="p">,</span> <span class="mo">0444</span><span class="p">,</span> <span class="n">disk_events_show</span><span class="p">,</span> <span class="nb">NULL</span><span class="p">);</span>
<span class="k">static</span> <span class="k">const</span> <span class="nf">DEVICE_ATTR</span><span class="p">(</span><span class="n">events_async</span><span class="p">,</span> <span class="mo">0444</span><span class="p">,</span> <span class="n">disk_events_async_show</span><span class="p">,</span> <span class="nb">NULL</span><span class="p">);</span>
<span class="k">static</span> <span class="k">const</span> <span class="nf">DEVICE_ATTR</span><span class="p">(</span><span class="n">events_poll_msecs</span><span class="p">,</span> <span class="mo">0644</span><span class="p">,</span>
...
<span class="cm"> * /sys/module/block/parameters/events_dfl_poll_msecs.</span>
<span class="cm"> */</span>
...
<span class="p">{</span>
	...
	<span class="k">if</span> <span class="p">(</span><span class="o">!</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">fops</span><span class="o">-&gt;</span><span class="n">check_events</span> <span class="o">||</span> <span class="o">!</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">events</span><span class="p">)</span>
		<span class="k">return</span><span class="p">;</span>
...
<span class="k">static</span> <span class="kt">void</span> <span class="nf">disk_del_events</span><span class="p">(</span><span class="k">struct</span> <span class="n">gendisk</span> <span class="o">*</span><span class="n">disk</span><span class="p">)</span>
<span class="p">{</span>
	<span class="k">if</span> <span class="p">(</span><span class="n">disk</span><span class="o">-&gt;</span><span class="n">ev</span><span class="p">)</span> <span class="p">{</span>
		<span class="n">disk_block_events</span><span class="p">(</span><span class="n">disk</span><span class="p">);</span>
...
<div class='footer'>generated by <a href='https://git.zx2c4.com/cgit/about/'>cgit 1.2.3-1.el7</a> (<a href='https://git-scm.com/'>git 2.26.2</a>) at 2021-10-28 07:52:36 +0000</div>
</div> <!-- id=cgit -->
</body>
</html>
